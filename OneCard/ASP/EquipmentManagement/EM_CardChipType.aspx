<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EM_CardChipType.aspx.cs" Inherits="ASP_EquipmentManagement_EM_CardChipType" EnableEventValidation="false" %>
	        ...
	        <div class="con">
		        ...
		        <div class="kuang5">
			        <div class="gdtb" style="height:305px">
			            ...
			            <asp:GridView ID="lvwCardChipType" runat="server"
                                Width = "1000"
                                CssClass="tab1"
                                ...
                                AllowPaging="true"
                                PageSize="10"
                                OnPageIndexChanging="lvwCardChipType_Page"
                                PagerSettings-Mode="NumericFirstLast"
                                PagerStyle-HorizontalAlign="left"
                                PagerStyle-VerticalAlign="Top"
                                AutoGenerateColumns="False"         
                                OnSelectedIndexChanged="lvwCardChipType_SelectedIndexChanged"
                                OnRowCreated="lvwCardChipType_RowCreated">
                            <Columns>
                                <asp:BoundField DataField="CardChipTypeCODE"   HeaderText="卡芯片类型编码"/>
                                <asp:BoundField DataField="CardChipTypeNAME"    HeaderText="卡芯片类型名称"/>
                                <asp:BoundField DataField="CardChipTypeNOTE"  HeaderText="卡芯片类型说明"/>
