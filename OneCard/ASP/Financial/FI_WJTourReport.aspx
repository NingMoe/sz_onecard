<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_WJTourReport.aspx.cs"
    Inherits="ASP_Financial_FI_WJTourReport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>吴江旅游年卡报表</title>
                ...
                <div class="kuang5">
                    <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text25">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="selTradeType" CssClass="input" runat="server" AutoPostBack="true"
                                    OnSelectedIndexChanged="selTradeType_change">
                                    <asp:ListItem Text="0: 汇总" Value="0"></asp:ListItem>
                                    <asp:ListItem Text="1: 售卡明细" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="2: 消费明细" Value="2"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td>
                                <div align="right">
                                    <asp:Label ID="lbl1" runat="server" Text="开卡方式:"></asp:Label></div>
                            </td>
                            <td>
                                <asp:DropDownList ID="selNewCardType" CssClass="input" runat="server" AutoPostBack="true">
                                    <asp:ListItem Text="1: POS机开卡" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="2: 业务系统开卡" Value="2"></asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td align="right">
                        ...
                        <table id="printReport" width="95%">
                            <tr align="center">
                                <td style="font-size: 16px; font-weight: bold">
                                    <asp:Label ID="labTitle" runat="server" Text="吴江旅游年卡汇总"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td>
