<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_DeptBalTrade_OutcomeFin.aspx.cs"
    Inherits="ASP_Financial_FI_DeptBalTrade_OutcomeFin" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>佣金转账日报明细</title>
                    ...
                    <div class="gdtbfix" style="height: 380px;">
                        ...
                        <asp:GridView ID="gvResult" runat="server" Width="95%" CssClass="tab2" HeaderStyle-CssClass="tabbt"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="CANCELTYPECODE" HeaderText="返销类型" />
