<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_ZZCardConsumerReport.aspx.cs"
    Inherits="ASP_Financial_FI_ZZCardConsumerReport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>转转卡刷卡记录表</title>
                    ...
                    <div class="kuang5">
                        <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text25">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox runat="server" ID="txtCardNo" MaxLength="16" CssClass="input"></asp:TextBox>
                                </td>
                                <td></td>
                                <td align="right">
