<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_CardFeeMonthlyReport.aspx.cs" Inherits="ASP_Financial_FI_CardFeeMonthlyReport" %>
            ...
            <table border="0" width="95%">
              ...
              <div id="printarea" class="kuang5">
                <div id="gdtbfix" style="height:380px">
                    <table id="printReport" width ="45%">
                        <tr align="center">
                            <td style ="font-size:16px;font-weight:bold">卡费月报</td>
                        </tr>
                        <tr>
                            <td>
