<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_CCSaleDailyReport.aspx.cs" Inherits="ASP_Financial_FI_CCSaleDailyReport" %>
              ...
              <div id="printarea" class="kuang5">
                <div id="gdtbfix" style="height:380px;">
                    <table id="printReport" width ="95%">
                        <tr align="center">
                            <td style ="font-size:16px;font-weight:bold">充值卡销售日报</td>
                        </tr>
                        <tr>
                            <td>
