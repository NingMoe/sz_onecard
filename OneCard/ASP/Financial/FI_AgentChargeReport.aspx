<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_AgentChargeReport.aspx.cs" Inherits="ASP_Financial_FI_AgentChargeReport" %>
              ...
              <div id="printarea" class="kuang5">
                <div id="gdtbfix" style="height:380px">
                    <table id="printReport" width ="80%">
                        <tr align="center">
                            <td style ="font-size:16px;font-weight:bold">代理充值对帐表</td>
                        </tr>
                        <tr>
                            <td>
