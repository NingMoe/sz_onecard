<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_SellChange_Report.aspx.cs" Inherits="ASP_Financial_FI_SellChange_Report" %>
              ...
              <div id="printarea" class="kuang5">
                <div id="gdtbfix" style="height:360px;">
                    ...
                    <table id="printReport" width ="80%">
                        <tr align="center">
                            <td style ="font-size:16px;font-weight:bold">售换卡汇总表</td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <asp:GridView ID="gvResult" runat="server"
                            ...
                            ShowFooter="false" HeaderStyle-HorizontalAlign="Center" RowStyle-HorizontalAlign="Center">
