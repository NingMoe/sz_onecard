<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_CCHQSaleReport.aspx.cs" Inherits="ASP_Financial_FI_CCHQSaleReport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>充值卡总部直销对帐</title>
              ...
              <div id="printarea" class="kuang5">
                <div id="gdtbfix" style="height:380px">
                    <table id="printReport" width ="95%">
                        <tr align="center">
                            <td style ="font-size:16px;font-weight:bold">充值卡总部直销对帐表</td>
                        </tr>
                        <tr>
                            <td>
