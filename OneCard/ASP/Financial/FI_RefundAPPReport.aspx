<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_RefundAPPReport.aspx.cs" Inherits="ASP_Financial_FI_RefundAPPReport" %>
               ...
               <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text25">
                   <tr>
                      ...
                      <td >
                            ...
                            <td width="12%">
                               <asp:DropDownList ID="selChannel" CssClass="inputmid" runat="server">
                                    <asp:ListItem Text="---请选择---" Value="" Selected="true"></asp:ListItem>
                                    <asp:ListItem Text="01: APP" Value="01" ></asp:ListItem>
                                    </asp:DropDownList>
                            </td>
                        <td align="right">
              ...
              <div id="printarea" class="kuang5">
                <div id="gdtbfix" style="height:380px">
                    <table id="printReport" width ="80%">
                        <tr align="center">
                            <td style ="font-size:16px;font-weight:bold">充值补登报表</td>
                        </tr>
                        <tr>
                            <td>
