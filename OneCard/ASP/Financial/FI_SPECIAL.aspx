<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_SPECIAL.aspx.cs" Inherits="ASP_Financial_FI_SPECIAL" %>
           ...
           <div class="kuang5">
               <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text25">
                   <tr>
                        ...
                        <td><div align="right">异常类型:</div></td>
                        <td><asp:DropDownList ID="selType" CssClass="inputmid" runat="server"></asp:DropDownList>
                        </td>
                        <td align="right">
