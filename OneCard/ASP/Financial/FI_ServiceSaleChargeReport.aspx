<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_ServiceSaleChargeReport.aspx.cs" Inherits="ASP_Financial_FI_ServiceSaleChargeReport" %>
	        ...
	        <div class="con">
               ...
               <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text25">
                   <tr>
                        ...
                        <td><div align="right">充值点:</div></td>
                        <td><asp:DropDownList ID="selBalunit" AutoPostBack="true" runat="server"></asp:DropDownList></td>
                        <td align="right">
              ...
              <div id="printarea" class="kuang5">
                <div id="gdtbfix" style="height:380px">
                    <table id="printReport" width ="95%">
                        <tr align="center">
                            <td style ="font-size:16px;font-weight:bold">客服售充对帐</td>
                        </tr>
                        <tr>
                            <td>
