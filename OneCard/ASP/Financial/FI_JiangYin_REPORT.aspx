<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_JiangYin_REPORT.aspx.cs" Inherits="ASP_FI_JiangYin_REPORT" %>
             ...
             <div id="printarea" class="kuang5">
              <div class="gdtbfix" style="height:380px;">
                    <table id="printReport" width ="95%">
                        <tr align="center">
                            <td style ="font-size:16px;font-weight:bold">江阴账单</td>
                        </tr>
                        <tr>
                            <td>
