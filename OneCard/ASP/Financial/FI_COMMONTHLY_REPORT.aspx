<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_COMMONTHLY_REPORT.aspx.cs" Inherits="ASP_Financial_FI_COMMONTHLY_REPORT" %>
              ...
              <div id="printarea" class="kuang5">
                <div id="gdtbfix" style="height:360px;">
                    ...
                    <table id="printReport" width ="80%">
                        <tr align="center">
                            <td style ="font-size:16px;font-weight:bold">信息亭佣金月报</td>
                        </tr>
                        <tr>
                            <td>
