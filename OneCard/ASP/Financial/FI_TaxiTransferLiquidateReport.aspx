<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_TaxiTransferLiquidateReport.aspx.cs" Inherits="ASP_Financial_FI_TaxiTransferLiquidateReport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>出租车转帐清算表</title>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">  
            ...
            <table border="0" width="95%">
                <tr>
                    ...
                    <td align="right">
                        <asp:Button ID="btnExport" runat="server" Text="导出Excel" CssClass="button1" OnClick="btnExport_Click" />
              ...
              <div id="printarea" class="kuang5">
                <div id="gdtbfix" style="height:380px;">
                    <table id="printReport" width ="60%">
                        <tr align="center">
                            <td style ="font-size:16px;font-weight:bold">出租车转帐清算表</td>
                        </tr>
                        <tr>
                            <td>
