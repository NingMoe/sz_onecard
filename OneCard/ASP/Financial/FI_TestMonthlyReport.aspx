<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_TestMonthlyReport.aspx.cs" Inherits="ASP_Financial_FI_TestMonthlyReport" %>
              ...
              <div id="printarea" class="kuang5">
                <div id="gdtbfix" style="height:360px;">
                    ...
                    <table id="printReport" width ="80%">
                        <tr align="center">
                            <td style ="font-size:16px;font-weight:bold">公交测试月报</td>
                        </tr>
                        <tr>
                            <td>
