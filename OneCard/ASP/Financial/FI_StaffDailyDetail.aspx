<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_StaffDailyDetail.aspx.cs" Inherits="ASP_Financial_FI_StaffDailyDetail" EnableSessionState="ReadOnly"%>
              ...
              <div id="printarea" class="kuang5">
                <div id="gdtbfix" style="height:360px;">
                    ...
                    <table id="printReport" width ="95%">
                        <tr align="center">
                            <td style ="font-size:16px;font-weight:bold">营业员日报明细</td>
                        </tr>
                        <tr>
                            <td>
