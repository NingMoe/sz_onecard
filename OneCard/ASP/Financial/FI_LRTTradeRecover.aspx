<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_LRTTradeRecover.aspx.cs"
    Inherits="ASP_Financial_FI_LRTTradeRecover" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>轻轨交易异常回收</title>
        ...
        <ContentTemplate>
            ...
            <div class="con">
                ...
                <div id="printarea" class="kuang5">
                    <div id="gdtbfix" style="height: 360px;overflow: auto;"">
                        ...
                        <asp:GridView ID="gvResult" runat="server" Width="95%" CssClass="tab2" HeaderStyle-CssClass="tabbt"
                            ...
                            PageSize="100" AllowPaging="True" OnPageIndexChanging="gvResult_PageIndexChanging">
                        </asp:GridView>
                    </div>
                </div>
            </div>
