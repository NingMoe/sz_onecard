<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_DeptOperReport.aspx.cs" Inherits="ASP_Financial_FI_DeptOperReport" %>
              ...
              <div id="printarea" class="kuang5">
                <div id="gdtbfix" style="height:380px">
                    <table id="printReport" width ="95%">
                        <tr align="center">
                            <td style ="font-size:16px;font-weight:bold">网点业务量报表</td>
                        </tr>
                        <tr>
                            <td>
