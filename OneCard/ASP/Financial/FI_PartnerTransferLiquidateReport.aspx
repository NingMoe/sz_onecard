<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_PartnerTransferLiquidateReport.aspx.cs" Inherits="ASP_Financial_FI_PartnerTransferLiquidateReport" %>
               ...
               <table border="0" cellpadding="0" cellspacing="0" class="text25">
                   <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            <asp:TextBox runat="server" ID="txtBalUnitName" CssClass="input" AutoPostBack="true" OnTextChanged="queryBalUnit"></asp:TextBox>
		                    <asp:DropDownList ID="selBalUnit" CssClass="inputmid" runat="server" AutoPostBack="true" OnSelectedIndexChanged="selBalUnit_Change"></asp:DropDownList>
		                    <asp:TextBox ID="txtBalUnit" MaxLength="8" CssClass="input" runat="server"></asp:TextBox>
                        </td>
              ...
              <div id="printarea" class="kuang5">
                <div id="gdtbfix" style="height:360px;">
                    ...
                    <table id="printReport" width ="80%">
                        <tr align="center">
                            <td style ="font-size:16px;font-weight:bold">商户转帐清算表</td>
                        </tr>
                        <tr>
                            <td>
