<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_POS_TRADE_RELATION.aspx.cs" Inherits="ASP_Financial_FI_POS_TRADE_RELATION" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>POS商户对应分析</title>
              ...
              <div id="printarea" class="kuang5">
                <div id="gdtbfix" style="height:380px">
                    <table id="printReport" width ="95%">
                        <tr align="center">
                            <td style ="font-size:16px;font-weight:bold">POS商户对应分析</td>
                        </tr>
                        <tr>
                            <td>
