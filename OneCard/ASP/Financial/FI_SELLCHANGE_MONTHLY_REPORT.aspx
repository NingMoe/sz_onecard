<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_SELLCHANGE_MONTHLY_REPORT.aspx.cs"
    Inherits="ASP_Financial_FI_SELLCHANGE_MONTHLY_REPORT" %>
                ...
                <div class="kuang5">
                    <table border="0" cellpadding="0" cellspacing="0" class="text25">
                        <tr>
                            ...
                            <td width="15%">
                                <asp:TextBox runat="server" ID="txtMonth" MaxLength="8" CssClass="input"></asp:TextBox>
                                <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtMonth"
                                    Format="yyyyMM" />
                            </td>
                            <td width="15%">
                                <div align="right">
