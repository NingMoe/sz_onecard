<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_SZTC_ComeRenewReport.aspx.cs" Inherits="ASP_Financial_FI_SZTC_ComeRenewReport" %>
              ...
              <div id="printarea" class="kuang5">
                <div id="gdtbfix" style="height:380px">
                    <table id="printReport" width ="95%">
                        <tr align="center">
                            <td style ="font-size:16px;font-weight:bold">旅游卡转收入</td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <asp:GridView ID="gvResult" runat="server"
                            ...
                            ShowFooter="true" >
                            <Columns>
                                <asp:BoundField DataField="OPERATETIME" HeaderText="转收入日期" />
                                <asp:BoundField DataField="DEPARTNAME" HeaderText="部门" />
                                <asp:BoundField DataField="COUNTNUM" HeaderText="数量" />
                                <asp:BoundField DataField="TRADEPROCFEE" HeaderText="手续费" />
                                <asp:BoundField DataField="DEPOSIT" HeaderText="押金" />
                                <asp:BoundField DataField="SUMMONEY" HeaderText="小计" />
                            </Columns>
                            <EmptyDataTemplate>
