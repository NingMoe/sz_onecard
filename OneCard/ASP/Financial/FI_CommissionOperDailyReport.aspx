<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_CommissionOperDailyReport.aspx.cs" Inherits="ASP_Financial_FI_CommissionOperDailyReport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>商户佣金凭证管理日报</title>
                    ...
                    <div class="kuang5">
                        <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text25">
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="selArea" CssClass="inputmid" runat="server">
                                    </asp:DropDownList>
                                </td>
                                <td>
                                    <div align="right">消费方式:</div>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlMode" CssClass="inputmid" runat="server">
                                    <asp:ListItem Text="---请选择---" Value=""></asp:ListItem>
                                    <asp:ListItem Text="脱机" Value="0"></asp:ListItem>
                                    <asp:ListItem Text="联机" Value="1"></asp:ListItem>
                    ...
                    <div id="printarea" class="kuang5">
                        <div id="gdtbfix" style="height: 380px">
                            <table id="printReport" width="95%">
                                <tr align="center">
                                    <td style="font-size: 16px; font-weight: bold">商户佣金凭证管理日报</td>
                                </tr>
                                <tr>
                                    <td>
