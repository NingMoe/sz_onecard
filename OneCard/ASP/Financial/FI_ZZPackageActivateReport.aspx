<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_ZZPackageActivateReport.aspx.cs"
    Inherits="ASP_Financial_FI_ZZPackageActivateReport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>转转卡激活统计报表</title>
                    ...
                    <div class="kuang5">
                        <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text25">
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="selPackageType" CssClass="inputmid" runat="server">
                                        <asp:ListItem Text="---请选择---" Value="" />
                                        <asp:ListItem Text="Z1:200套餐" Value="Z1" />
                                        <asp:ListItem Text="Z2:288套餐" Value="Z2" />
                                    </asp:DropDownList>
                                </td>
                                <td>
                                    <div align="right">
                    ...
                    <div id="printarea" class="kuang5">
                        <div id="gdtbfix" style="height: 380px; overflow: auto;">
                            <table id="printReport" width="80%">
                                <tr align="center">
                                    <td style="font-size: 16px; font-weight: bold">转转卡激活统计
                                    </td>
                                </tr>
                            </table>
                            <asp:GridView ID="gvResult" runat="server" Width="95%" CssClass="tab2" HeaderStyle-CssClass="tabbt"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="ACTIVATEDATE" HeaderText="激活时间" />
                                    <asp:BoundField DataField="PACKAGETYPE" HeaderText="套餐类型" />
                                    <asp:BoundField DataField="PACKAGETIMES" HeaderText="激活次数" />
                                    <asp:BoundField DataField="PACKAGEMONEY" HeaderText="激活金额" />
                                </Columns>
                                <EmptyDataTemplate>
