<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_LRTTradeMendLiquidate.aspx.cs" Inherits="ASP_Financial_FI_LRTTradeMendLiquidate" %>
              ...
              <div id="printarea" class="kuang5">
                <div id="gdtbfix" style="height:360px;">
                    ...
                    <table id="printReport" width ="80%">
                        <tr align="center">
                            <td style ="font-size:16px;font-weight:bold">轻轨交易补录转帐清算表</td>
                        </tr>
                        <tr>
                            <td>
