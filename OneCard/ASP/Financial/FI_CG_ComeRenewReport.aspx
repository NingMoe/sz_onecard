<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_CG_ComeRenewReport.aspx.cs" Inherits="ASP_Financial_FI_CG_ComeRenewReport" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>利金卡转收入统计</title>
              ...
              <div id="printarea" class="kuang5">
                <div id="gdtbfix" style="height:360px;">
                    ...
                    <table id="printReport" width ="80%">
                        <tr align="center">
                            <td style ="font-size:16px;font-weight:bold">利金卡转收入统计</td>
                        </tr>
                        <tr>
                            <td>
