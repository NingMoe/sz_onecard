...
using TM;
public partial class ASP_Financial_FI_ZZParkActivateReport : Master.ExportMaster
{
    ...
    private DataTable initEmptyDataTable()
    {
        ...
        dt.Columns["TRADEDATE"].MaxLength = 100;
        dt.Columns["BALUNITNAME"].MaxLength = 100;
        dt.Columns["CONSUMERTIMES"].MaxLength = 100;
    ...
    private DataTable fillDataTable(HttpHelper.TradeType tradetype, Dictionary<string, string> postData)
    {
        ...
        foreach (JProperty itemProperty in deserObject.Properties())
        {
            ...
            else if (propertyName == "parkActivateColl")
            {
        ...
        if (code == "0000") //表示成功
        {
            ...
            {
                string propertyName = itemProperty.Name;
                if (propertyName == "parkActivateColl")
                {
                    //DataTable赋值
    ...
    protected void btnQuery_Click(object sender, EventArgs e)
    {
        ...
        DataTable data = fillDataTable(HttpHelper.TradeType.ZZParkActivateQuery, DeclarePost());
