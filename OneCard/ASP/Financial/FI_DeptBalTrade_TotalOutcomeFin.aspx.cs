...
public partial class ASP_Financial_FI_DeptBalTrade_TotalOutcomeFin : Master.ExportMaster
{
    ...
    protected void btnQuery_Click(object sender, EventArgs e)
    {
        ...
        DataTable data = SPHelper.callQuery("SP_PS_Query_Report", context, "QueryTotalOutcomeFin", txtFromDate.Text, txtToDate.Text, selBalUnit.SelectedValue, ddlFinTypecode.SelectedValue);
    ...
    protected void gvResult_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {
            totalbalfee += Convert.ToDouble(GetTableCellValue(e.Row.Cells[1]));
            totalTimes += Convert.ToInt32(GetTableCellValue(e.Row.Cells[2]));
            cancelTotalBalFee += Convert.ToDouble(GetTableCellValue(e.Row.Cells[3]));
            cancelTotalTimes += Convert.ToInt32(GetTableCellValue(e.Row.Cells[4]));
            transFee += Convert.ToDouble(GetTableCellValue(e.Row.Cells[5]));
            transTimes += Convert.ToInt32(GetTableCellValue(e.Row.Cells[6]));
            comFee += Convert.ToDouble(GetTableCellValue(e.Row.Cells[7]));
        }
        else if (e.Row.RowType == DataControlRowType.Footer)  //页脚 
        {
            e.Row.Cells[0].Text = "总计";
            e.Row.Cells[1].Text = totalbalfee.ToString("n");
            e.Row.Cells[2].Text = totalTimes.ToString();
            e.Row.Cells[3].Text = cancelTotalBalFee.ToString("n");
            e.Row.Cells[4].Text = cancelTotalTimes.ToString();
            e.Row.Cells[5].Text = transFee.ToString("n");
            e.Row.Cells[6].Text = transTimes.ToString();
