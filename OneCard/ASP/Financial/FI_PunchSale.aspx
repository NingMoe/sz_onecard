<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FI_PunchSale.aspx.cs" Inherits="ASP_Financial_FI_PunchSale" %>
              ...
              <div id="printarea" class="kuang5">
                <div id="gdtbfix" style="height:360px">
                    <table id="printReport" width ="95%">
                        <tr align="center">
                            <td style ="font-size:16px;font-weight:bold">售卡刷卡表</td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="YEARSUPPLYMONEY" HeaderText="1-12月充值量:万元" />
