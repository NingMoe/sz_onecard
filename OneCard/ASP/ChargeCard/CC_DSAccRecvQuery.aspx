<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CC_DSAccRecvQuery.aspx.cs" Inherits="ASP_ChargeCard_CC_DSAccRecvQuery" %>
  ...
  <div class="kuang5">
    <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text25">
      <tr>
        ...
        <td width="20%"><asp:TextBox runat="server" ID="txtCustName" CssClass="input" MaxLength="14"></asp:TextBox>
        </td>
        <td align="right">
        ...
        OnPageIndexChanging="gvResult_Page">
           <Columns>
             <asp:TemplateField ItemStyle-Width="5%">
               ...
               <asp:BoundField HeaderText="到帐日期" DataField="PAYTIME" DataFormatString="{0:yyyymmdd}"/>
