<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CC_StockOut.aspx.cs" Inherits="ASP_ChargeCard_CC_StockOut" %>
      ...
      <tr>
        ...
        <tr>
            <td align="right" width="10%">
                领用部门:</td>
            <td colspan="6">
                <asp:DropDownList ID="selAssignedDepart" CssClass="input" runat="server"></asp:DropDownList></td>
        </tr>
    </table>
  </div>
  </div>
...
<div class="btns">
  ...
  <tr>
    <td width="70%">&nbsp;</td>
    <td align="right"><asp:Button ID="btnSubmit" Enabled="false" CssClass="button1" runat="server" Text="出库" OnClick="btnSubmit_Click"/></td>
  </tr>
</table>
