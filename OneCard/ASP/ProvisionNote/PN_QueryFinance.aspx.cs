...
public partial class ASP_ProvisionNote_PN_QueryFinance : Master.ExportMaster
{
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //REPORT1-SHYH
            dt = queryDt("QUERYREPORT", "TF_F_BFJ_REPORT1", date, "SHYH", "19");
            workbook = NPOI(workbook, dt, "表1-1 (上海)", title, 10);
            ...
            //REPORT2
            dt = queryDt("QUERYREPORT_2", "TF_F_BFJ_REPORT2", date, "SHYH", "9");
            workbook = NPOI(workbook, dt, "表1-2 (上海)", title, 7);
            ...
            //REPORT6
            dt = queryDt("QUERYREPORT", "TF_F_BFJ_REPORT6", date, "SHYH", "25");
            workbook = NPOI(workbook, dt, "表1-6 (上海)", title, 8);
            ...
            //REPORT9
            dt = queryDt("QUERYREPORT", "TF_F_BFJ_REPORT9", date, "SHYH", "4");
            workbook = NPOI(workbook, dt, "表1-9 (上海)", title, 5);
            ...
            //REPORT10-SHYH
            dt = queryDt("QUERYREPORT", "TF_F_BFJ_REPORT10", date, "SHYH", "24");
            workbook = NPOI(workbook, dt, "表1-10 (上海)", title, 7);
            ...
            //REPORT2-1
            dt = queryDt("QUERYREPORT", "TF_F_BFJ_REPORT2_1", date, "", "49");
            ...
            dt = queryDt("QUERYSPE", "TF_F_BFJ_REPORT2_1", time1.ToString("yyyyMMdd"), "", "17");
            workbook = SetValue(workbook, "附2-1", GetValue(dt), 5, 51);

            //
            workbook = SetValue(workbook, "附2-1", "0.00", 6 + DateTime.ParseExact(date, "yyyyMMdd", null).Day, 51);
