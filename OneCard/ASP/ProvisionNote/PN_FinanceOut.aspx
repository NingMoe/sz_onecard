<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="PN_FinanceOut.aspx.cs"
    Inherits="ASP_ProvisionNote_PN_FinanceOut" %>
                ...
                <div class="btns">
                    <table width="350px" align="right" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="Button2" Text="确认完成" CssClass="button1" runat="server" OnClick="btnConfirm_Click"
                                    OnClientClick="if(!confirm('是否出金确认完成，确认完成后，所有未匹配账务进入当日未达帐!')) return false;" />
                            </td>
                        </tr>
                    </table>
                </div>
