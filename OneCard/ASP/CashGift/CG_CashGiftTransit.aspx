<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CG_CashGiftTransit.aspx.cs" Inherits="ASP_CashGift_CG_CashGiftTransit" %>
...
<script runat="server" >public override void ErrorMsgShow(){ErrorMsgHelper(bulMsgShow);}</script>  
  ...
  <div class="kuang5">
   ...
   <tr>
     ...
     <td><asp:TextBox ID="eDate" CssClass="labeltext" runat="server" Text=""></asp:TextBox></td>
     <td><div align="right">卡钱包1:</div></td>
