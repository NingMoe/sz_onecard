<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CG_CashGiftDelay.aspx.cs" Inherits="ASP_CashGift_CG_CashGiftDelay" %>
...
<body>
 ...
 <div class="money">有效期延长</div>
 <div class="kuang5">
 <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text20">
  <tr>
    <td width="10%" align="right">有效期延长到:</td>
    <td width="20%" colspan="3"><asp:TextBox runat="server" ID="txtExpDate" CssClass="inputmid"   Width="60px" MaxLength="8"/><span class="red">*</span>(yyyyMMdd)
