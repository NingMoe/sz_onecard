...
public partial class ASP_CashGift_CG_ChangeCardRollback : Master.FrontMaster
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            setReadOnly(OsDate, ODeposit, OldcMoney, ReasonType, LabCardtype, NsDate, NewcMoney, txtWallet2);
    ...
    protected void initLoad(object sender, EventArgs e)
    {
        ...
        ddoTD_M_TRADEFEETDOIn.TRADETYPECODE = "F4";
    ...
    protected void readChangeInfo(object sender, EventArgs e)
    {
        ...
        //OsDate.Text = ddoTF_F_CARDRECOut.SERSTARTTIME.ToString("yyyyMMdd");

        //从业务台帐主表中读取数据
        TF_B_TRADETDO ddoTF_B_TRADEIn = new TF_B_TRADETDO();
        ddoTF_B_TRADEIn.OLDCARDNO = txtOCardno.Text;
        ddoTF_B_TRADEIn.TRADETYPECODE = "54";
    ...
    protected void btnDBRead_Click(object sender, EventArgs e)
    {
        ...
        ddoTF_F_CARDRECIn.CARDNO = txtOCardno.Text;
        TF_F_CARDRECTDO ddoTF_F_CARDRECOut = (TF_F_CARDRECTDO)tmTMTableModule.selByPK(context, ddoTF_F_CARDRECIn, typeof(TF_F_CARDRECTDO), null);
        OldcMoney.Text = ((Convert.ToDecimal(ddoTF_F_CARDEWALLETACCOut.CARDACCMONEY) - Convert.ToDecimal(ddoTF_F_CARDRECOut.DEPOSIT)) / (Convert.ToDecimal(100))).ToString("0.00");
    ...
    protected void btnReadNCard_Click(object sender, EventArgs e)
    {
        ...
        //卡账户有效性检验
        checkCashGiftAccountInfo(txtNCardno.Text);
        ...
        if (!context.hasError())
        {
            ...
            ddoTD_M_CARDTYPEIn.CARDTYPECODE = txtNCardno.Text.Substring(4,2);
            ...
            {
                context.AddError("电子钱包2不为10元,不能换卡返销");
                return;
            }
            //从IC卡资料表中读取数据
    ...
    protected void btnRollback_Click(object sender, EventArgs e)
    {
        ...
        string strSale = " Select TRADETYPECODE From TF_B_TRADE WHERE CARDNO = '" + txtNCardno.Text + "' " +
                         ...
                         " AND TRADETYPECODE = '54' AND CANCELTAG = '0') " +
        ...
        SP_CG_ChangeCardRollbackPDO pdo = new SP_CG_ChangeCardRollbackPDO();
        ...
        data = SPHelper.callQuery("SP_CG_Query", context,
            "QryCashGiftCardPrice", txtNCardno.Text);
        ...
        if (ok)
        {
            ...
            ASHelper.preparePingZheng(ptnPingZheng, txtOCardno.Text, hidCustname.Value, "利金卡换卡返销", "0.00"
