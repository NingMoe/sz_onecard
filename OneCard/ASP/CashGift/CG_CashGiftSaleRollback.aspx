<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CG_CashGiftSaleRollback.aspx.cs" Inherits="ASP_CashGift_CG_CashGiftSaleRollback" %>
...
<asp:HiddenField runat="server" ID="hidAccRecv" />
  ...
  <tr>
    <td><div align="right">应退金额:</div></td>
