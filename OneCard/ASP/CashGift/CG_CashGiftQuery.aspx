<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CG_CashGiftQuery.aspx.cs" Inherits="ASP_CashGift_CG_CashGiftQuery" %>
 ...
 <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text20">
  <tr>
    ...
    <td width="24%"><asp:Button ID="btnReadCard" Text="读卡" CssClass="button1" runat="server" 
        OnClientClick="return ReadCashGiftInfo(assignGiftFunc)" OnClick="btnReadCard_Click"/>
        &nbsp;
        <asp:Button ID="btnReadDBCard" Text="读数据库" CssClass="button1" runat="server" 
        OnClick="btnReadDBCard_Click"/></td>
  ...
  <tr>
    <td align="right">归属网点:</td>
    <td><asp:Label ID="labAssignedDept"  runat="server" /></td>
    <td align="right">是否回收卡:</td>
    <td><asp:Label ID="labIsRecycle"  runat="server" /></td>
    <td align="right">回收时间:</td>
    <td><asp:Label ID="labRecycleTime" runat="server" /></td>
    <td align="right"></td>
    <td></td>
  </tr>
</table>
