<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TS_SettleDetail.aspx.cs" Inherits="ASP_TaxiService_TS_SettleDetail" %>
        ...
        <div class="base">查询方式</div>
         ...
         <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text25">
          ...
          <tr>
           ...
           <td>
            <asp:DropDownList ID="selCorp" CssClass="inputmidder" AutoPostBack="true" OnSelectedIndexChanged="selCorp_SelectedIndexChanged" runat="server"/>
           </td>
