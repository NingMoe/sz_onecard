<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WA_AntiWarnManage.aspx.cs" Inherits="ASP_Warn_WA_AntiWarnManage" EnableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <script>
        function closeConfirm() {
            MyExtConfirm('确认', '是否确定关闭所有选中主体？', closeConfirmCb);
            return false;
        }
      ...
      <ContentTemplate>
        ...
        <div class="con">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="12text">
              <tr>
                <td ><div class="jieguo">可疑主体列表</div></td>
                ...
                <td>
                    关闭原因：<asp:TextBox ID="txtClose" style="border: 1px solid #979797;width: 200px;font-size: 12px;" runat="server"></asp:TextBox>
                </td>
                 <td>
...
--%>
              ...
              <asp:GridView ID="gvResult" runat="server"
                ...
                <HeaderTemplate>#</HeaderTemplate>
                  ...
                  <asp:BoundField DataField="TASKDAY"    HeaderText="监控任务日期" />
                  <asp:BoundField DataField="LASTTIME"    HeaderText="监控时间"  HtmlEncode="false" DataFormatString="{0:yyyy-MM-dd HH:mm}" />
                </Columns>     
...
--%>            </div>
             <table width="100%" border="0" cellpadding="0" cellspacing="0" class="12text">
              <tr>
                <td width="14%"><div class="jieguo">主体交易列表</div></td>
