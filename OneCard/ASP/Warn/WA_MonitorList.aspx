<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WA_MonitorList.aspx.cs" Inherits="ASP_Warn_WA_MonitorList" %>
        ...
        <div class="con">
         ...
         <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text25">
          <tr>
            ...
            <td align="right">告警条件:</td>
            <td><asp:DropDownList ID="selCondCode1" CssClass="inputmid" runat="server"/></td>
            <td align="right">告警类型:</td>
            <td><asp:DropDownList ID="selWarnType1" CssClass="inputmid" runat="server"/></td>
        ...
        EmptyDataText="没有数据记录!">
         ...
         <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text25">
          <tr>
            ...
            <td><asp:Label runat="server" ID="labSeqNo"/></td>
           <td align="right">卡号:</td>
            <td><asp:TextBox runat="server" ID="txtCardNo" CssClass="inputmid"  MaxLength="16"/><span class="red">*</span></td>
            <td align="right">告警条件:</td>
            <td><asp:DropDownList ID="selCondCode" CssClass="inputmid" runat="server"/><span class="red">*</span></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td align="right">告警类型:</td>
