<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WA_LRTBlackListIssue.aspx.cs"
    Inherits="ASP_Warn_WA_SubwayBlackListIssue" EnableEventValidation="false" %>
                ...
                <div class="kuang5">
                    <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text25">
                        <tr>
                            ...
                            <td width="10%">
                                <asp:DropDownList ID="dropBlackListTypeQ" runat="server">
                                </asp:DropDownList>
                            </td>
                            <td width="10%">
                                <div align="right">
                    ...
                    <div id="gdtb" style="height: 280px;">
                        <asp:GridView ID="gvResult" runat="server" CssClass="tab1" Width="100%" HeaderStyle-CssClass="tabbt"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="LISTTYPENAME" HeaderText="名单类型" />
                                <asp:BoundField DataField="REMARK" HeaderText="录入原因" />
                                <asp:BoundField DataField="OVERTIMEMONEY" HeaderText="超时金额" />
                ...
                <div class="kuang5">
                    <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text25">
                        <tr>
                            ...
                            <td width="22%">
                                <asp:TextBox runat="server" ID="txtMOney" CssClass="input" MaxLength="6" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="dropBlackListType" runat="server">
                                </asp:DropDownList>
                                <span class="red">*</span>
                            </td>
                            <td align="right">
                            ...
                            <td colspan="2" align="right">
                                <asp:Button ID="btnBlackAdd" Text="增加" CssClass="button1" runat="server" OnClick="btnBlackAdd_Click" />&nbsp;&nbsp;&nbsp;
                    ...
                    <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text25">
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:Button ID="btnBatchAdd" CssClass="button1" runat="server" Text="导入" 
