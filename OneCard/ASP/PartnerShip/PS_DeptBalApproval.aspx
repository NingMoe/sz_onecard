<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PS_DeptBalApproval.aspx.cs"
    Inherits="ASP_PartnerShip_PS_DeptBalApproval" EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>网点结算单元审批</title>
            ...
            <div class="pipinfoz3">
                ...
                <div class="kuang5" style="height: 70px;">
                    <div class="gdtb2" style="height: 100%;">
                        ...
                        <asp:GridView Visible="false" ID="lvwBalRelationScheme" runat="server" Width="300"
                            CssClass="tab1" HeaderStyle-CssClass="tabbt" AlternatingRowStyle-CssClass="tabjg"
                            SelectedRowStyle-CssClass="tabsel" AllowPaging="True" PageSize="10" PagerSettings-Mode="NumericFirstLast"
                ...
                <div class="kuang5" style="height: 90px;">
                    <div class="gdtb2" style="height: 100%;">
                        <asp:GridView ID="lvwExistedComScheme" runat="server" Width="400" CssClass="tab1"
                            ...
                            OnPageIndexChanging="lvwExistedComScheme_Page" PagerStyle-VerticalAlign="Top"
                        ...
                        <asp:GridView Visible="false" ID="lvwExistedRelationScheme" runat="server" Width="300"
                            CssClass="tab1" HeaderStyle-CssClass="tabbt" AlternatingRowStyle-CssClass="tabjg"
                            SelectedRowStyle-CssClass="tabsel" AllowPaging="True" PageSize="5" PagerSettings-Mode="NumericFirstLast"
                            OnPageIndexChanging="lvwExistedRelationScheme_Page" PagerStyle-HorizontalAlign="left"
                            PagerStyle-VerticalAlign="Top" AutoGenerateColumns="False">
                            <Columns>
                                <asp:BoundField DataField="DBALUNIT" HeaderText="结算单元" />
                                <asp:BoundField DataField="DEPARTNAME" HeaderText="网点" />
