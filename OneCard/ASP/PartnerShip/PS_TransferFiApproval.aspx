<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PS_TransferFiApproval.aspx.cs" Inherits="ASP_PartnerShip_PS_TransferFiApproval"  EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
   <title>结算单元财务审核</title>
...
<body>
    <form id="form1" runat="server">
      <div class="tb">合作伙伴->结算单元信息财务审核</div>
      <ajaxToolkit:ToolkitScriptManager runat="Server" EnableScriptGlobalization="true"
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
         ...
         <script runat="server" >public override void ErrorMsgShow(){ErrorMsgHelper(bulMsgShow);}</script>
           ...
           <div class="con">
              <div class="jieguo">待审核结算单元信息</div>
              <div class="kuang5">
                <div class="gdtb" style="height:180px">
                   ...
                   <asp:GridView ID="lvwBalUnitsFiAppral" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CHECKSTAFF"      HeaderText="审批员工"/>  
                        <asp:BoundField DataField="CHECKTIME"       HeaderText="审批时间"/>     
                        <asp:BoundField DataField="CHANNELNO"       HeaderText="通道编号" Visible="false"/> 
             ...
             <div class="kuang5">
               ...
               <table width="760" border="0" cellpadding="0" cellspacing="0" class="text25">
                 ...
                 <tr>
                   ...
                   <td align="right">审批员工:</td>
                   <td><asp:Label ID="labCheckStuff" runat="server"/></td>
                 ...
                 <tr>
                   ...
                   <td colspan="3"><asp:Label ID="labBankAccNo" runat="server"/></td>
                   <td colspan="2">&nbsp;</td>
                  </tr>
               </table>
               <div class="linex"></div>
