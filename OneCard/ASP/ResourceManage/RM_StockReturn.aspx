<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RM_StockReturn.aspx.cs" Inherits="ASP_ResourceManage_RM_StockReturn" %>
        ...
        <ContentTemplate>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox runat="server" TextMode="MultiLine" ID="txtRemark" CssClass="inputlong"
                                    Width="313px" Height="60px" MaxLength="800" />
                                <span class="red">*</span>
                            </td>
                        </tr>
                    </table>
            ...
            <div class="btns">
                <table width="200" border="0" align="right" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="70%">
                            <asp:Button ID="btnPrint" Text="打印退库单" CssClass="button1" runat="server" OnClick="btnPrint_Click" />&nbsp;
                        </td>
                        <td align="right">
                            &nbsp;&nbsp;
                ...
                <asp:CheckBox ID="chkOrder" runat="server" Checked="true" />自动打印退库单
            </div>
