<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RM_GetResourceApply.aspx.cs" Inherits="ASP_ResourceManage_RM_GetResourceApply" %>
                ...
                <div class="kuang5">
                    <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text25">
                        ...
                        <tr>
                            ...
                            <td colspan="7">
                                <asp:TextBox ID="txtApplyNum" CssClass="input"  runat="server"></asp:TextBox> <span
                                    class="red">*</span>
                            </td>
                        </tr>
                        <tr >
                            ...
                            <div>
                              <asp:Panel  ID= "divAttribute2" runat="server"  >
                                    ...
                                    <td colspan="3" width="36%">
                                      ...
                                      <asp:DropDownList ID="ddlAttribute2" CssClass="inputmid" runat="server"></asp:DropDownList> <span ID="spanAttribute2" class = " red"  visible="false"   runat="server">*</span>
                        ...
                        <td width="12%" align="right">
                            ...
                            <td width="36%" colspan="3">
                                <asp:DropDownList ID="ddlAttribute3" CssClass="inputmid" runat="server"></asp:DropDownList> <span ID="spanAttribute3" class = " red"  visible="false"   runat="server">*</span>
                            ...
                            <td width="36%" colspan="3">
                               <asp:DropDownList ID="ddlAttribute4" CssClass="inputmid" runat="server"></asp:DropDownList> <span ID="spanAttribute4" class = " red"  visible="false"   runat="server">*</span>
                        ...
                        <td width="12%" align="right">
                            ...
                            <td width="36%" colspan="3">
                                <asp:DropDownList ID="ddlAttribute5" CssClass="inputmid" runat="server"></asp:DropDownList> <span ID="spanAttribute5" class = " red"  visible="false"   runat="server">*</span>
                            ...
                            <td width="36%" colspan="3">
                               <asp:DropDownList ID="ddlAttribute6" CssClass="inputmid" runat="server"></asp:DropDownList> <span ID="spanAttribute6" class = " red"  visible="false"   runat="server">*</span>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="txtUseWay" CssClass="inputlong" runat="server" 
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="txtRemark" CssClass="inputlong" runat="server" 
