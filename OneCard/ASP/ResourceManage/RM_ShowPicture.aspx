<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RM_ShowPicture.aspx.cs" Inherits="ASP_ResourceManage_RM_ShowPicture" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
           <ContentTemplate>
                <div class="con">
                        <table>
                                <tr>
                                    <td><img src="../../Images/cardface.jpg" alt="卡正面"  id="Img" runat="server" height="200" style="cursor:hand" /></td>
                                </tr>
                                <tr>
