<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PB_B_Card_ReturnCardRollback.aspx.cs" Inherits="ASP_PersonalBusiness_PB_B_Card_ReturnCardRollback" %>
...
<div class="btns">
  ...
  <tr>
    ...
    <td style="height: 24px"><asp:Button ID="btnRollback" CssClass="button1" runat="server" Text="退卡返销" Enabled=false OnClick="btnRollback_Click" /></td>
  </tr>
</table>
