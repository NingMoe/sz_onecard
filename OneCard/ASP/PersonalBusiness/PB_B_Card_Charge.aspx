<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PB_B_Card_Charge.aspx.cs" Inherits="ASP_PersonalBusiness_PB_B_Card_Charge" %>
...
个人业务->吴江B卡充值
          ...
          <script type="text/javascript" language="javascript">
                //The status code returned from the server was: 12031 wdx 20111212
...
<script runat="server" >public override void ErrorMsgShow(){ErrorMsgHelper(bulMsgShow);}</script>  
 ...
 <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text20">
  ...
  <tr>
    ...
    <td><asp:TextBox ID="eDate" CssClass="labeltext"  Visible="False" width=100 runat="server" Text=""></asp:TextBox></td>
  ...
  <tr>
    ...
    <td colspan="7">
     ...
     <td width="12%"><asp:Button ID="btnCheckRead" CssClass="button1" runat="server" Text="充值校验" 
        OnClientClick="return readCardForCheck()"/></td>
   </tr>
</table>
 ...
 <img src="../../Images/show.JPG" alt="充值" /></div>
  ...
  <table width="200" border="0" cellspacing="0" cellpadding="0">
     <tr>
       <td colspan="2">请选择充值类型</td>
       </tr>
     <tr>
       <td width="80"><asp:RadioButton ID="Cash" Visible=true Checked=true Text="现金" GroupName="SupplyMoney" TextAlign=Right AutoPostBack=true runat=server OnCheckedChanged="Cash_CheckedChanged" /></td>
       <td width="80"></td>
     </tr>
     <tr>
       <td colspan="2"></td>
     ...
     <tr>
       <td colspan="2" class="red"><asp:Label runat="server" ID="labPrompt" Text="请输入充值金额:"></asp:Label></td>
      </tr>
     <tr>
     <tr>
     ...
     <tr>
       ...
       <asp:LinkButton runat="server" ID="charge60" Text="充75元" OnClientClick="return setChargeValue(75);"></asp:LinkButton>
...
<table width="200" border="0" align="right" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td><asp:Button ID="btnSupply" CssClass="button1" runat="server" Text="充值" Enabled=false 
    OnClientClick="return SupplyCheck()"/></td>
  </tr>
</table>
