<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PB_B_Card_ReturnCard.aspx.cs" Inherits="ASP_PersonalBusiness_PB_B_Card_ReturnCard" %>
...
<script runat="server" >public override void ErrorMsgShow(){ErrorMsgHelper(bulMsgShow);}</script>  
 ...
 <table width="98%" border="0" cellpadding="0" cellspacing="0" class="text20">
  <tr>
    ...
    <td width="13%"><asp:TextBox ID="LabAsn" ReadOnly=true CssClass="labeltext" runat="server"></asp:TextBox></td>
    <td width="10%"><div align="right">退卡类型:</div></td>
    <td width="12%"><asp:DropDownList ID="selReasonType" AutoPostBack=true OnSelectedIndexChanged="selReasonType_SelectedIndexChanged" runat="server"></asp:DropDownList></td>
    <td width="13%"><div align="right"><asp:Button ID="btnReadCard" CssClass="button1" runat="server" Text="读卡" 
        OnClientClick="return ReadCardInfo()" OnClick="btnReadCard_Click" /></div></td>
    <td width="10%">&nbsp;</td>
  </tr>
  <tr>
    <td width="10%"><div align="right">启用日期:</div></td>
    <td width="13%"><asp:TextBox ID="sDate" CssClass="labeltext" ReadOnly=true runat="server" Text=""></asp:TextBox></td>
    <td width="10%"><div align="right" style="display: none">结束日期:</div></td>
    <td width="13%"><asp:TextBox ID="eDate" CssClass="labeltext" Visible="False" ReadOnly=true  runat="server" Text=""></asp:TextBox></td>
    <td width="10%"><div align="right">余额:</div></td>
    <td width="12%"><asp:TextBox ID="cMoney" CssClass="labeltext" ReadOnly=true  runat="server" Text=""></asp:TextBox></td>
    <td width="13%"></td>
    <td width="10%">&nbsp;</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><div align="right"><asp:Button ID="btnDBRead" CssClass="button1" Enabled=false runat="server" Text="读数据库" OnClick="btnDBRead_Click" /></div></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
 ...
 <table width="98%" border="0" cellpadding="0" cellspacing="0" class="text20">
  <tr>
    ...
    <td width="12%"><asp:Label ID="Papertype" runat="server" Text=""></asp:Label></td>
...
<div class="btns">
  ...
  <tr>
    ...
    <td><asp:Button ID="btnReturnCard" CssClass="button1" runat="server" Text="退卡" Enabled=false OnClick="btnReturnCard_Click" /></td>
  </tr>
</table>
