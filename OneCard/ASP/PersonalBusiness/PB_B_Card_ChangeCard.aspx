<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PB_B_Card_ChangeCard.aspx.cs"
    Inherits="ASP_PersonalBusiness_PB_B_Card_ChangeCard" %>
                    ...
                    <div class="bigkuang">
                        ...
                        <div class="big">
                            <table width="200" border="0" cellpadding="0" cellspacing="0" class="text25">
                                <tr>
                                    <td>
                                        <asp:RadioButton ID="Deposit" runat="server" Text="卡押金" AutoPostBack="true" TextAlign="right"
                                            OnCheckedChanged="Deposit_Changed" GroupName="FEETYPE" />
                                    </td>
                                    <td>
                                        <asp:RadioButton ID="Cardcost" runat="server" Text="卡费" AutoPostBack="true" TextAlign="right"
                                            OnCheckedChanged="Cardcost_Changed" GroupName="FEETYPE" />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="80">
