<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PB_CardToCardOut.aspx.cs"
    Inherits="ASP_PersonalBusiness_PB_CardToCardOut" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        function UnloadCheck() {
            ...
            MyExtConfirm('提示', '确认是否圈提' + $get("txtDealMoney").value + '元', RecoverCheckConfirm);
            return false;
        }
                ...
                <div class="kuang5">
                    <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text20">
                        <tr>
                            ...
                            <td style="width: 12%">
                                <asp:TextBox ID="txtDealMoney" runat="server" CssClass="input" MaxLength="7"></asp:TextBox>
                            </td>
                            <td style="width: 12%">
                                <div align="right">
                                    备注:</div>
                            ...
                            <td style="width: 48%" colspan="4">
                                <asp:TextBox ID="txtReMark" runat="server" CssClass="inputlong" MaxLength="50"></asp:TextBox>
                                &nbsp
                                <asp:Button ID="txtReadPaper" Text="读二代证" CssClass="button1" runat="server" OnClientClick="return readThisIDCard();" />
                            </td>
                            </td>
                            <td width="12%">
                                &nbsp;
                ...
                <div class="kuang5">
                    <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text20">
                        ...
                        <tr>
                            ...
                            <td align="left">
                                &nbsp
                                <asp:Button ID="btnLoad" CssClass="button1" runat="server" Text="圈提" Enabled="false"
