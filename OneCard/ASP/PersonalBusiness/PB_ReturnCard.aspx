<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PB_ReturnCard.aspx.cs" Inherits="ASP_PersonalBusiness_PB_ReturnCard" %>
        ...
        <contenttemplate>
            ...
            <div class="con">
                ...
                <div class="kuang5">
                    ...
                    <asp:HiddenField ID="hidCustPaperType" runat="server" />
                    <table width="98%" border="0" cellpadding="0" cellspacing="0" class="text20">
                        ...
                        <tr>
                            ...
                            <td width="13%">
                                <asp:TextBox ID="eDate" CssClass="labeltext" Visible="False" ReadOnly="true" runat="server" Text=""></asp:TextBox>
                            </td>
                            <td width="10%">
                                <div align="right">
                                    余额:</div>
            ...
            <div class="btns">
                <table width="200" border="0" align="right" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnReturnCard" CssClass="button1" runat="server" Text="退卡" Enabled="false"
