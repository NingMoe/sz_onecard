<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PB_Query.aspx.cs" Inherits="ASP_PersonalBusiness_PB_Query" %>
...
<div class="con">
 ...
 <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text20">
  ...
  <tr>
    ...
    <td width="11%"><div align="right">结束日期:</div></td>
    <td width="14%"><asp:TextBox ID="eDate" CssClass="labeltext" runat="server" Text=""></asp:TextBox></td>
...
<div class="jieguo">
  ...
  <tr>
    ...
    <td width="21%">&nbsp;</td>
    <td width="21%">&nbsp;</td>
    <td width="24%"><asp:Button ID="btnQuery" CssClass="button1" runat="server" Text="查询" 
