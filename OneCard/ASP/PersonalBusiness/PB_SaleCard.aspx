<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PB_SaleCard.aspx.cs" Inherits="ASP_PersonalBusiness_PB_SaleCard" %>
                ...
                <div class="kuang5">
                    <table width="180" border="0" cellpadding="0" cellspacing="0" class="tab1">
                        ...
                        <tr class="tabjg">
                            ...
                            <td>
                                <asp:Label ID="SupplyOtherFee" runat="server" Text=""></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <tr class="tabjg">
                                ...
                                <td>
                                    <asp:Label ID="TotalSupply" runat="server" Text=""></asp:Label>
                                </td>
                            </tr>
                    </table>
                </div>
                        ...
                        <div class="big2" style="height: 95px">
                            <table width="280" border="0" cellspacing="0" cellpadding="0" id="SupplyTable">
                                ...
                                <tr>
                                    ...
                                    <td width="112">
                                        <div align="center">
                                            <asp:LinkButton runat="server" ID="linkbtnSupply" OnClick="btnSupply_Click" />
                                            <asp:Button ID="btnSupply" CssClass="button1" runat="server" Text="充值" Enabled="false"
                                                OnClientClick="return saleSupplyCheck()" />
                                        </div>
                                    </td>
                                </tr>
                            </table>
