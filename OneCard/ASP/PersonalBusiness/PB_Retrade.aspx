<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PB_Retrade.aspx.cs" Inherits="ASP_PersonalBusiness_PB_Retrade" EnableEventValidation="false" %>
...
<asp:HiddenField ID="hidState" runat="server" />
  ...
  <asp:GridView ID="lvwQuery" runat="server"
                    ...
                    <Columns>
                      ...
                      <asp:BoundField DataField="strStaffno"       HeaderText="出租司机工号"/>
                      <asp:BoundField DataField="strTaxino"       HeaderText="出租司机车号"/>
                      <asp:BoundField DataField="strState"       HeaderText="出租司机状态编码"/>
