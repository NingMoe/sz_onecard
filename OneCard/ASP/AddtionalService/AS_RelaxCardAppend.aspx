<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AS_RelaxCardAppend.aspx.cs" Inherits="ASP_AddtionalService_AS_RelaxCardAppend" %>
...
<body>
 ...
 <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text20">
  <tr>
    ...
    <td width="9%"><div align="right">休闲到期:</div></td>
  ...
  <tr>
    ...
    <td><asp:Label ID="labUpdateTime"  runat="server" /></td>
    <td><div align="right">开通套餐:</div></td>
    <td><asp:Label ID="labPackage"  runat="server" /></td>
    <td><div align="right">账户类型:</div></td>
    <td><asp:Label ID="labAccountType"  runat="server" /></td>
  </tr>  
</table>
