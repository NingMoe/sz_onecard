<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AS_MonthlyCardYearCheck.aspx.cs" Inherits="ASP_AddtionalService_AS_MonthlyCardYearCheck" %>
...
<body>
            ...
            <div class="con">
                ...
                <div class="kuang5">
                    <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text25">
                        ...
                        <asp:HiddenField runat="server" ID="HidNewYearInfo" />
            ...
            <div class="kuang5">
                    <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text20">
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="selDate" AutoPostBack="true" CssClass="input" runat="server" OnSelectedIndexChanged="selDate_SelectedIndexChanged">
                                </asp:DropDownList>
                                &nbsp;&nbsp;
                                <asp:CheckBox ID="toDate1" AutoPostBack="true" runat="server" OnCheckedChanged="toDate1_CheckedChanged"/>
                                &nbsp;&nbsp;&nbsp;
                                <asp:CheckBox ID="toDate2" AutoPostBack="true" runat="server" OnCheckedChanged="toDate1_CheckedChanged"/>
                                &nbsp;&nbsp;&nbsp;
                                <asp:CheckBox ID="toDateForLM" AutoPostBack="true" runat="server" Text="2018年12月31日" OnCheckedChanged="toDateForLM_CheckedChanged" />
                            </td>
                        </tr>
                    </table>
                </div>
 ...
 <div width="300px" class="big122">
    <table style="background: #ffffff" width="270" border="0" cellpadding="0" cellspacing="0" class="text30">
      ...
      <tr>
        <td width="50%" align="center"><label>保险费:&nbsp;</label></td>
        <td width="50%"><div><asp:Label ID="inMoney" runat="server" Text="10"></asp:Label>元/年</div></td>
      </tr>
      <tr>
        <td align="center">缴费年数:&nbsp;</td>
        <td><div><asp:Label ID="yearNum" runat="server" Text="0"></asp:Label></div></td>
      </tr>
      <tr>
