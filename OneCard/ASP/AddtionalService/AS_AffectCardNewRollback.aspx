<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AS_AffectCardNewRollback.aspx.cs" Inherits="ASP_AddtionalService_AS_AffectCardNewRollback" %>
                    ...
                    <div class="kuang5">
                        <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text20">
                            <tr>
                                ...
                                <td width="13%">
                                    <asp:TextBox ID="txtCardNo" CssClass="labeltext" runat="server" /></td>
                                <td width="9%">
                                    <div align="right">交易类型:</div>
                                </td>
                                <td width="13%">
                                    <asp:Label ID="labTradeType" CssClass="labeltext" runat="server" /></td>
                                <td width="9%">
                                    <div align="right">交易时间:</div>
                                </td>
                                <td width="17%">
                                    <asp:Label ID="labTradeTime" CssClass="labeltext" runat="server" /></td>
                                <td width="1%">&nbsp;</td>
                                <td width="24%">
                                ...
                                <asp:HiddenField runat="server" ID="hidXFCardNo" />
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="selPaperType" runat="server" /></td>
                                <td align="right">证件号码:</td>
                                <td>
                                    <asp:Label ID="txtPaperNo" runat="server" /></td>
                            </tr>
                            <tr>
                                <td>
                                    <div align="right">开通套餐:</div>
                                </td>
                                <td>
                                    <asp:Label ID="labPackage" runat="server" /></td>
                                <td>
                                    <div align="right">应退费用:</div>
                                </td>
                                <td colspan="5">
                                    <asp:Label ID="labFee" CssClass="labeltext" runat="server" /></td>
                            </tr>
                        </table>
