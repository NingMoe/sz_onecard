<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HYDROPOWER_CHARGE_STATEMENT_QUERY.aspx.cs" Inherits="ASP_Financial_HYDROPOWER_CHARGE_STATEMENT_QUERY" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>公共事业代缴对账查询</title>
	        ...
	        <div class="con">
               ...
               <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text25">
                   ...
                   <tr>
                        ...
                        <td><div align="right">对账状态:</div></td>
                        <td>
              ...
              <div id="printarea" class="kuang5">
                <div id="gdtbfix" style="height:360px;">
                    ...
                    <table id="printReport" width ="95%">
                        <tr align="center">
                            <td style ="font-size:16px;font-weight:bold">公共事业缴费对账结果</td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        OnRowDataBound="gvResult_OnRowDataBound">
                            <Columns>
                                ...
                                <asp:BoundField DataField="REAL_AMOUNT" HeaderText="缴费金额:元" NullDisplayText="0" DataFormatString="{0:n}"
                                    HtmlEncode="false" />
                                <asp:BoundField DataField="CHARGE_STATUS_DISPLAY" HeaderText="对账状态" />
