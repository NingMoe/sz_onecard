<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AS_MonthlyCardChangeRollback.aspx.cs" Inherits="ASP_AddtionalService_AS_MonthlyCardChangeRollback" %>
...
<asp:HiddenField runat="server" ID="hidAccRecv" />
  ...
  <tr>
    <td><div align="right">换卡类型:</div></td>
    <td><asp:DropDownList runat="server" ID="selReason"   Enabled="false">
    </asp:DropDownList></td>
    <td><div align="right">应退费用:</div></td>
    <td colspan="5"><asp:Label ID="labFee" CssClass="labeltext" runat="server" /></td>
  </tr>
</table>
