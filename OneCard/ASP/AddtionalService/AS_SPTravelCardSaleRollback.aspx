<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AS_SPTravelCardSaleRollback.aspx.cs"
    Inherits="ASP_AddtionalService_AS_SPTravelCardSaleRollback" %>

<%@ Register Src="../../CardReader.ascx" TagName="CardReader" TagPrefix="cr" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>世乒旅游-售卡返销</title>
                ...
                <div class="kuang5">
                    <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text20">
                        <tr>
                            ...
                            <td width="25%">
                                <asp:Button ID="btnReadCard" CssClass="button1" runat="server" Text="读卡" OnClientClick="return ReadShiPingInfo()"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="SaleStaff" runat="server" Text=""></asp:Label>
                            </td>
                            <td>
                                <div align="right">
                                    售卡时间:</div>
                            ...
                            <td>
                                <asp:Label ID="SaleDate" runat="server" Text=""></asp:Label>
                            </td>
                            <td>
                                <div align="right">
                                    开通线路:</div>
            ...
            <div class="btns">
                <table width="200" border="0" align="right" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnRollback" CssClass="button1" runat="server" Text="售卡返销" Enabled="false"
