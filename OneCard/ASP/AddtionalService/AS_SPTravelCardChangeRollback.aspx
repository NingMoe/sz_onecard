<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AS_SPTravelCardChangeRollback.aspx.cs"
    Inherits="ASP_AddtionalService_AS_SPTravelCardChangeRollback" %>

<%@ Register Src="../../CardReader.ascx" TagName="CardReader" TagPrefix="cr" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>世乒旅游-换卡返销</title>
            ...
            <div class="con">
                ...
                <div class="kuang5">
                    <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text20">
                        <tr>
                            ...
                            <td width="11%">
                                <asp:TextBox ID="txtOCardno" CssClass="input" MaxLength="16" runat="server"></asp:TextBox>
                            </td>
                            <td width="11%">
                                <div align="right">
                                    旧卡卡费:</div>
                            ...
                            <td width="20%">
                                <asp:TextBox ID="ReasonType" CssClass="labeltext" runat="server"></asp:TextBox>
                            </td>
                            <td width="11%">
                                <asp:Button ID="btnReadCard" CssClass="button1" runat="server" Text="读卡" OnClientClick="return ReadShiPingInfo('txtOCardno')"
                                    OnClick="btnReadCard_Click" />
                            </td>
                            <td width="14%">
                                <asp:Button ID="btnDBRead" CssClass="button1" runat="server" Text="读数据库" OnClick="btnDBRead_Click" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td >
                                <asp:TextBox ID="txtOldFunFee" CssClass="labeltext" runat="server" Text=""></asp:TextBox>
                            </td>--%>
                            <td>
                                <div align="right">
                                    &nbsp;</div>
                ...
                <div class="kuang5">
                    <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text20">
                        <tr>
                            ...
                            <td width="14%">
                                <asp:Button ID="btnReadNCard" CssClass="button1" Enabled="false" runat="server" Text="读新卡"
                                    OnClientClick="return ReadShiPingInfo('txtNCardno')" OnClick="btnReadNCard_Click" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="txtNewFunFee" CssClass="labeltext" runat="server" Text=""></asp:TextBox>
                            </td>
                            <td>
                                <div align="right">
                                    新卡余额:</div>
                            ...
                            <td >
                               <%-- <asp:TextBox ID="txtOpenLine" CssClass="labeltext" runat="server" Text=""></asp:TextBox>--%>
                            </td>
                        </tr>
                         <tr>
                         <td>
                        ...
                        <asp:HiddenField ID="hidFunctionFee" runat="server" />
                        ...
                        <asp:HiddenField ID="hiddenOShiPingTag" runat="server" />
                        ...
                        <div class="big">
                            <table width="200" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div align="center">
                                            <asp:Label ID="ReturnSupply" runat="server" Text=""></asp:Label></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" class="red">
