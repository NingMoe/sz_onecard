<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AS_SPTravelCardAppend.aspx.cs"
    Inherits="ASP_AddtionalService_AS_SPTravelCardAppend" %>
                ...
                <div class="kuang5">
                    <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text20">
                        <tr>
                            ...
                            <td width="13%">
                                <asp:TextBox ID="labEndDate" CssClass="labeltext" runat="server" />
                            </td>
                             <td width="9%">
                                <div align="right">
                                    开通员工:</div>
                            ...
                            <td width="9%">
                                <asp:Button ID="btnReadCard" Text="读卡" CssClass="button1" runat="server" OnClientClick="return ReadShiPingInfo()"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="labDbOpenLines" runat="server" />
                            </td>
                             <td>
                                <div align="right">
                                    卡内标志:</div>
                            ...
                            <td>
                                <asp:Label ID="labCardSign" runat="server" />
                            </td>
                             <td>
                                &nbsp;
                            </td>
                ...
                <div class="kuang5" style="display: none">
                    <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text25">
                        <tr>
                            ...
                            <td width="13%">
                                <asp:Label ID="txtCustName" runat="server" />
                            </td>
                            <td width="9%">
                                <div align="right">
                                    出生日期:</div>
                            ...
                            <td width="13%">
                                <asp:Label ID="txtCustBirth" runat="server" />
                            </td>
                            <td width="9%">
                                <div align="right">
                                    证件类型:</div>
                    ...
                    <div class="gdtb" style="height: 220px">
                        <asp:GridView ID="gvResult" runat="server" Width="98%" CssClass="tab1" HeaderStyle-CssClass="tabbt"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField ItemStyle-Width="15%" HeaderText="景点标志" DataField="TRAVELSIGN" />
                            ...
                            <%--    <asp:BoundField ItemStyle-Width="10%" HeaderText="结算日期" DataField="DEALTIME" DataFormatString="{0:yyyy-MM-dd}"
                                    HtmlEncode="False" />--%>
                            </Columns>
                            <EmptyDataTemplate>
