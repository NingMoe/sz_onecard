<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AS_SPTravelCardChange.aspx.cs"
    Inherits="ASP_AddtionalService_AS_SPTravelCardChange" %>
                ...
                <div class="kuang5">
                    <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text20">
                        ...
                        <tr>
                            ...
                            <td >
                                <asp:TextBox ID="txtOldFunFee" CssClass="labeltext" runat="server"></asp:TextBox>
                            </td>
                ...
                <div class="kuang5">
                    <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text20">
                        ...
                        <tr>
                            ...
                            <td >
                                <asp:TextBox ID="txtNewFunFee" CssClass="labeltext" runat="server"></asp:TextBox>
                            </td>
