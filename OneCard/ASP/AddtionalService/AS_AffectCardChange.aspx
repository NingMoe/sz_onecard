<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AS_AffectCardChange.aspx.cs"
    Inherits="ASP_AddtionalService_AS_AffectCardChange" EnableEventValidation="false" %>
                    ...
                    <div class="kuang5">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="text20">
                            <tr>
                                ...
                                <td width="10%">
                                    <asp:Button ID="btnReadCard" Text="读新卡" CssClass="button1" runat="server" OnClientClick="return readXXParkInfo()"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="labAccountType" CssClass="labeltext" runat="server" />
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="kuang5">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="text25">
                            <tr>
                                ...
                                <td width="20%">
                                    <div align="left">
                                        <asp:DropDownList runat="server" ID="selPackageType" Enabled="false" />
                                    </div>
                                </td>
                                <td width="10%">
