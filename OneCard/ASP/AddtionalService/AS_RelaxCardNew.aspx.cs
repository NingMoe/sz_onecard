...
// 惠民休闲年卡开通处理
//modify by jiangbb 2015-04-20 增加照片拍摄功能、开通方式


public partial class ASP_AddtionalService_AS_RelaxCardNew : Master.FrontMaster
{
    // 页面装载
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            annualFee.Text = "198.00";
            Total.Text = "198.00";
        }
        else if (radioXXGeneral.Checked)
        {
            annualFee.Text = "298.00";
            Total.Text = "298.00";
        }
        else if (radioWXGeneral.Checked)
        {
            annualFee.Text = "299.00";
            Total.Text = "299.00";
        }
        ...
        radioWXGeneral.Attributes["onfocus"] = "this.select();";
        radioWXGeneral.Attributes["onclick"] = "setWXGeneral(this);";
    ...
    protected void selChargeType_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (selChargeType.SelectedValue == "01") //现金
        {
            ...
            radioGeneral.Enabled = radioXXGeneral.Enabled = radioWXGeneral.Enabled = true;
        }
        else
        {
            txtPrompt.Text = "";
            ...
            radioGeneral.Enabled = radioXXGeneral.Enabled = radioWXGeneral.Enabled = false;
        }
        radioGeneral.Checked = radioXXGeneral.Checked = radioWXGeneral.Checked = false;
        txtRealRecv.Text = "";
        txtDiscount.Text = "";
        annualFee.Text = "0.00";
        Total.Text = "0.00";
    ...
    private void initLoad(object sender, EventArgs e)
    {
        ...
        //ddoTD_M_TRADEFEETDOIn.TRADETYPECODE = "25";
    ...
    void checkRelaxFeature()
    {
        ...
        DataTable openDayDt = ASHelper.callQuery(context, "CheckXXParkOpenDay", txtCardNo.Text);
        ...
        if (openDayDt != null && openDayDt.Rows.Count > 0)
        {
            ...
            {
                context.AddError("惠民休闲年卡当日开通，不允许再次开通!");
            }
        }
        ...
        hidWarning.Value += Server.HtmlDecode(
            "卡片已是惠民休闲年卡，且未到期;<br>休闲到期时间为:<span class='red'>" + row[0] + "</span><br>");
    }
    ...
    //private String readXXParkEndDate()
    //{
    //    // 计算惠民休闲年卡的结束日期设置，下一年当前月月底
    //    DateTime nowNextYear = DateTime.Now.AddYears(1);
    //    DateTime endDate = nowNextYear.AddDays(1 - nowNextYear.Day).AddMonths(1).AddDays(-1);
    ...
    protected void btnReadCard_Click(object sender, EventArgs e)
    {
        ...
        {
            hidWarning.Value += "当前卡片是由老卡换卡售出，<br>且老卡已经是有效惠民休闲年卡。<br><br>老卡号:<span class='red'>"
    ...
    protected void btnConfirm_Click(object sender, EventArgs e)
    {
        ...
        else if (hidWarning.Value == "writeSuccess")  // 写卡成功
        {
            ...
            AddMessage("D005050002: 惠民休闲年卡前台写卡成功，年卡已经开通");
        ...
        {
            context.AddError("A00505C001: 惠民休闲年卡前台写卡失败，年卡开通失败");
        }
    ...
    private void submitValidate()
    {
        ...
        if (radioGeneral.Checked == false && radioXXGeneral.Checked == false && radioWXGeneral.Checked == false)
        {
            context.AddError("A094780015:请选择一项休闲年卡套餐");
        }
    ...
    protected void txtPrompt_Changed(object sender, EventArgs e)
    {
        if (txtPrompt.Text.Trim().Length == 16)
        {
            ...
            if (dt.Rows[0][1].ToString() == "19800")
            {
                hidFuncType.Value = "0F";
                txtRealRecv.Text = "198";
                txtDiscount.Text = "0";
                radioGeneral.Checked = true;
                radioWXGeneral.Checked = false;
                radioXXGeneral.Checked = false;
                radioGeneral.Enabled = radioXXGeneral.Enabled = radioWXGeneral.Enabled = false;
                labPromptFor.Text = "兑换卡为198套餐";
            }
            else if (dt.Rows[0][1].ToString() == "29800")
            {
                hidFuncType.Value = "06";
                txtRealRecv.Text = "298";
                txtDiscount.Text = "0";
                radioGeneral.Checked = false;
                radioWXGeneral.Checked = false;
                radioXXGeneral.Checked = true;
                radioGeneral.Enabled = radioXXGeneral.Enabled = radioWXGeneral.Enabled = false;
                labPromptFor.Text = "兑换卡为298套餐";
            }
            else if (dt.Rows[0][1].ToString() == "29900")
            {
                hidFuncType.Value = "0E";
                txtRealRecv.Text = "299";
                txtDiscount.Text = "0";
                radioGeneral.Checked = false;
                radioXXGeneral.Checked = false;
                radioWXGeneral.Checked = true;
                radioGeneral.Enabled = radioXXGeneral.Enabled = radioWXGeneral.Enabled = false;
                labPromptFor.Text = "兑换卡为299套餐";
            }
            Page_Load(sender, e);
        }
    }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        string str = ASHelper.readXXParkTimes(context);
        int usableTimes = int.Parse(str);
        str = readXXParkEndDate();
        ...
        // 园林年卡的标志位为'01',惠民休闲年卡的套餐的标志位为hidFuncType.value.次数都是16进制.
        ...
        if (selChargeType.SelectedValue == "01") // 现金类型
        {
            ...
            packageTypeCode = radioGeneral.Checked ? "0F" : radioXXGeneral.Checked ? "06" : "0E";
        }
        //兑换卡类型
        else
        {
            ...
            if (hidFuncType.Value == "0F")
            {
                tradeFee = "19800";
            }
            else if (hidFuncType.Value == "06")
            {
                tradeFee = "29800";
            }
            else if (hidFuncType.Value == "0E")
            {
                tradeFee = "29900";
            }
            else
        ...
        context.AddField("p_ACCOUNTTYPE").Value = "0";      //账户类型 0：线下开通 1：线上开通
        ...
        // 执行存储过程
        bool ok = context.ExecuteSP("SP_AS_RelaxCardNew_BAT");
        ...
        if (ok)
        {
            ...
            //ASHelper.preparePingZheng(ptnPingZheng, txtCardNo.Text, txtCustName.Text, "休闲年卡开通", "0.00"
            ...
            ASHelper.preparePingZheng(ptnPingZheng, context.s_DepartName, context.s_UserID,
                "惠民休闲年卡开通", DealString.GetRecordID(hidTradeNo.Value, hidAsn.Value),
    ...
    private String readXXParkEndDate()
    {
        ...
        DataTable data = ASHelper.callQuery(context, "XXParkTagEndDate");
        if (data.Rows.Count == 0)
        {
            context.AddError("S00501B001: 缺少系统参数-惠民休闲年卡结束日期");
            return "";
        }
        Object[] row = data.Rows[0].ItemArray;
        return (string)row[0];
    ...
    private void checkParkIsInvalid()
    {
        ...
        if (data.Rows.Count != 0)
        {
            ...
            {
                context.AddError("A005020003:当前卡片已经是有效的亲子卡，且未到期，不可再次开通休闲年卡");
            }
        }
    }
}