<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CA_BatchChargeFiApproval.aspx.cs" Inherits="ASP_CustomerAcc_CA_BatchChargeFiApproval" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>专有账户批量充值财审</title>
...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
             ...
             <td class="cust_mid">专有账户>批量充值财务审批</td>
...
<div class="cust_tabbox">
          <table border="0" cellpadding="0" cellspacing="0" width="100%">
        	...
        	<table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td>
                    <div class="clearCheck" style="height:310px">
                               ...
                               <Columns>
                                 <asp:TemplateField>
                                   ...
                                   <asp:BoundField HeaderText="集团客户" DataField="CORPNAME"/>
                                    <asp:BoundField HeaderText="帐户数量" DataField="AMOUNT"/>
