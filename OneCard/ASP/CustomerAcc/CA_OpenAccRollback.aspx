<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CA_OpenAccRollback.aspx.cs"
    Inherits="ASP_CustomerAcc_CA_OpenAccRollback" EnableEventValidation="false" %>
    ...
    <form id="form1" runat="server">
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                ...
                <td class="cust_mid">专有账户->开户返销</td>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="cust_form">
                            ...
                            <tr>
                                <td colspan= 8>
                                    ...
                                    <div class="cust_bton1"><asp:LinkButton ID="btnReadCard"  runat="server" Text="读卡" OnClientClick="return ReadCardInfo()" OnClick="btnReadCard_Click" /></div>
                                </td>
                            </tr>
                        </table>
             </div>
            ...
            <div class="cust_tabbox">
                <div class="cust_bottom_bton"><asp:LinkButton ID="btnOpenAccRollback"  OnClick="btnOpenAccRollback_Click"
                                OnClientClick="return confirm('确认提交?');"    runat="server" Text="返销" Enabled="false" /></div>
