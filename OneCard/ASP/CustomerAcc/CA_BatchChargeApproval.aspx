<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CA_BatchChargeApproval.aspx.cs" Inherits="ASP_CustomerAcc_CA_BatchChargeApproval" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>专有账户批量充值审批</title>
...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <td class="cust_mid">专有账户>批量充值审批</td>
...
<div class="cust_tabbox">
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <td class="cust_top1_m"><span style="line-height:22px; margin-left:5px; color:#333;">充值审批</span></td>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="cust_form">
          <tr>
            ...
            <td style="width: 200px;">
                <asp:DropDownList ID="selBatchNo" CssClass="inputmid" runat="server" AutoPostBack="true" OnSelectedIndexChanged="selBatchNo_SelectedIndexChanged"/>
            </td>
            <th>集团客户：</th>
                <td><asp:DropDownList ID="selCorp" CssClass="inputmidder" runat="server" AutoPostBack="true" OnSelectedIndexChanged="selCorp_SelectedIndexChanged"></asp:DropDownList></td>
            <td width="17%" >   
  ...
  <div class="cust_tabbox">
          <table border="0" cellpadding="0" cellspacing="0" width="100%">
        	...
        	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="cust_form">
              <tr>
                     <th width="10%">单位：</th>
                     <td width="30%"><asp:Label ID="lblCorpName" runat="server"></asp:Label></td>
                     <th width="10%">帐户数量：</th>
                     <td width="10%"><asp:Label ID="labAmount" runat="server"></asp:Label></td>
                     <th width="10%">充值总额：</th>
                     <td width="30%"><asp:Label ID="labChargeTotal" runat="server"></asp:Label></td>
