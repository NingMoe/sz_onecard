<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CA_TransitBalance.aspx.cs"
    Inherits="ASP_CustomerAcc_CA_TransitBalance" EnableEventValidation="false" %>
...
<head runat="server">
  ...
  <!--
        ...
        function submitConfirm() {
            if ($("#Money").val() != "") {
                MyExtConfirm('确认', '是否确认转账:' + $("#Money").val() + '元?', fun);
                return false;
            }
            return true;
        }
  ...
  MSComm1_OnComm();
    ...
    function changeTransitmoney(realmoney)
    {
...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <td class="cust_mid">专有账户>账户互转</td>
            ...
            <ContentTemplate>
                ...
                <div class="cust_tabbox">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="cust_form">
                            <tr>
                                ...
                                <td>
                                    <div class="cust_bton1"><asp:LinkButton ID="btnReadCard"  runat="server" Text="读卡" OnClientClick="return ReadCardInfo('OtxtCardno')"
                            ...
                            <td>
                                <div style="height: 100px" class="gdtb">
                                    <asp:GridView ID="gvOutAccount" runat="server" Width="100%" CssClass="tab1" HeaderStyle-CssClass="tabbt"
                                        ...
                                        onselectedindexchanged="gvOutAccount_SelectedIndexChanged"
                            ...
                            <tr>
                                ...
                                <td colspan="2" align="center">
                                    <div class="cust_bton1"><asp:LinkButton ID="Button1"  runat="server" Text="读卡" OnClientClick="return ReadCardInfo('ItxtCardno')"
                                        OnClick="btnReadCard2_Click" /></div>
                            ...
                            <td>
                                <div style="height: 100px" class="gdtb">
                                        <asp:GridView ID="gvInAccount" runat="server" Width="100%" CssClass="tab1" HeaderStyle-CssClass="tabbt"
                                            ...
                                            onselectedindexchanged="gvInAccount_SelectedIndexChanged"
                                            EmptyDataText="没有数据记录!">
                                            <Columns>
                                                <asp:BoundField DataField="ACCT_TYPE_NAME" HeaderText="账户类型" />
                                                <asp:BoundField DataField="LIMIT_DAYAMOUNT" HeaderText="每日消费限额" />
                ...
                <div class="cust_tabbox">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <td>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <td class="cust_top1_l"><div class="cust_p11"></div></td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="cust_form2">
                                <td>
                                    <div class="spec_table spec_tableA">
                                        <div class="cust_tab_tu"></div>
                                        <div class="cust_tab_txt">请输入转账金额：</div>
                                        <div class="cust_tab_txt1">
                ...
                <div class="cust_tabbox">
                    <div class="cust_bottom_bton"><asp:LinkButton ID="btnTransAcc"  OnClick="btnSubmit_Click" runat="server"
                                    Text="转账" Enabled="false" OnClientClick="return submitConfirm()" />
                                    </div>
