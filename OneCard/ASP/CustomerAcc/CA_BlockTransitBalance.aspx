<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CA_BlockTransitBalance.aspx.cs" 
Inherits="ASP_CustomerAcc_CA_BlockTransitBalance" EnableEventValidation="false" %>
...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
            ...
            <td class="cust_mid">专有账户>挂失补账户</td>
...
<td class="cust_top1_l"><div class="cust_p6"></div></td>
                ...
                <div class="cust_tabbox">
                    ...
                    <tr>
                        ...
                        <td class="cust_top1_m"><span style="line-height:22px; margin-left:5px; color:#333;">挂失卡信息</span></td>
                        <td class="cust_top1_r"></td>
                    </tr>
                    </table>
                    <div class="cust_line1"></div>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="cust_form">
                            <tr>
                                ...
                                <td style="width: 15%">
                                    <asp:TextBox ID="OtxtCardno" CssClass="labeltext" ReadOnly="true" MaxLength="16" runat="server"></asp:TextBox>
                                </td>
                                <td style="width: 10%">
                                </td>
                                <td style="width: 15%">
                ...
                <div class="cust_tabbox">
                    ...
                    <tr>
                        ...
                        <td class="cust_top1_m"><span style="line-height:22px; margin-left:5px; color:#333;">挂失卡账户信息</span></td>
                        <td class="cust_top1_r"></td>
                    </tr>
                    </table>
                    <div class="cust_line1"></div>
                            ...
                            <tr>
                                ...
                                <td   colspan="4" align="center">
                                    <div class="cust_bton1"><asp:LinkButton ID="Button1"  runat="server" Text="读卡" OnClientClick="return ReadCardInfo('ItxtCardno')"
                                        ...
                                        <asp:LinkButton ID="Button2" runat="server" Text="读数据库" OnClick="btnNDBread_Click" /></div>&nbsp;
                                </td>
                            </tr>
                            <tr>
                                <th style="width: 10%">
                 ...
                 <div class="cust_tabbox" id="div_password" runat="server">
                    ...
                    <tr>
                        ...
                        <td class="cust_top1_m"><span style="line-height:22px; margin-left:5px; color:#333;">输入挂失卡密码</span></td>
                        <td class="cust_top1_r"></td>
                    </tr>
                    </table>
                    <div class="cust_line1"></div>
                ...
                <div class="cust_tabbox">
                    <div class="cust_bottom_bton"> <asp:LinkButton ID="btnTransAcc"  OnClick="btnSubmit_Click" runat="server"
                                        Text="挂失补账户" Enabled="false" OnClientClick="return confirm('确认提交?');" /></div>
                    ...
                    <div class="cust_bottom_txt"><span style="margin-right:5px;"><asp:CheckBox ID="chkPingzheng" runat="server" Checked="false" Text="自动打印凭证" /></span></div>
                </div>
               <div class="btns">
