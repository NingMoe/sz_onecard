<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GC_AccPassReset.aspx.cs" Inherits="ASP_GroupCard_GC_AccPassReset" %>
...
<asp:TextBox ID="txtCardno" CssClass="labeltext" runat="server" MaxLength="16" ></asp:TextBox>
    ...
    <td align="right"><asp:Button ID="btnQuery" CssClass="button1" runat="server" Text="读卡" 
        OnClientClick="return readCardNo()" OnClick="btnQuery_Click"/></td>
  </tr>
</table>
