<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="GC_OrderApproval.aspx.cs"
    Inherits="ASP_TianyiReport_SZ_OrderApproval" %>
                ...
                <div class="kuang5">
                    <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text25">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="selManagerDept" CssClass="inputmid" runat="server" AutoPostBack="true"
                                    OnSelectedIndexChanged="managerDept_Changed">
                                </asp:DropDownList>
                            </td>
                            <td>
                                <div align="right">
                ...
                <div class="kuang5" id="divCardInfo" style="display: none">
                    <table width="95%" border="0" cellpadding="0" cellspacing="0" class="text25">
                        <tr>
                            ...
                            <td width="44%" colspan="3">
                                <asp:TextBox ID="txtAccountName" CssClass="inputmid" runat="server"></asp:TextBox>
            ...
            <div class="btns">
                <table width="200px" border="0" align="right" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btnRollBack" Text="回 退" CssClass="button1" runat="server" OnClick="btnRollBack_Click" />
                        </td>
                    </tr>
                </table>
            </div>
