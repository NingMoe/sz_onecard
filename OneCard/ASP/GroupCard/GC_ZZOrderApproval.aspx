                    ...
                    <div class="gdtb" style="height: 350px; overflow: auto">
                        <asp:GridView ID="gvOrderList" Width="225%" CssClass="tab1" HeaderStyle-CssClass="tabbt"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="PACKAGEENDTIME" HeaderText="套餐有效期" />
                                <asp:BoundField DataField="ACTIVEENDTIME" HeaderText="激活有效期" />
                                <asp:BoundField DataField="RECEIVECUSTNAME" HeaderText="收货人" />
                                <asp:BoundField DataField="RECEIVEADRESS" HeaderText="收货地址" />
                                ...
                                <asp:BoundField DataField="DETAILID" HeaderText="子订单号" />
