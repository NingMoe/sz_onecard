<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IT_Query.aspx.cs" Inherits="ASP_InvoiceTrade_IT_Query" EnableEventValidation="false" %>
	...
	<div class="con">
		...
		<div class="kuang5">
            ...
            <div class="btns">
             ...
             <asp:Button ID="btnPrintFaPiao" runat="server" Text="补打印" CssClass="button1" OnClick="Print_Click" />
            </div>    
