<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IT_Distribution.aspx.cs"
    Inherits="ASP_InvoiceTrade_IT_Distribution" %>
            ...
            <ContentTemplate>
                ...
                <div class="btns">
                    <table width="100" border="0" align="right" cellpadding="0" cellspacing="0">
                        <tr>
                            <td>
                                <asp:LinkButton runat="server" ID="btnConfirm" OnClick="InvoiceDistrbution_Click" />
                                <asp:Button ID="Button1" CssClass="button1" runat="server" Text="发票分配" OnClick="InvoiceDistrbution_Click"
