<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IT_PrintJs.aspx.cs" Inherits="ASP_InvoiceTrade_IT_PrintJs" %>
                                                                    ...
                                                                    <td width="69%" valign="top">
                                                                        <table width="100%" height="192" border="0" cellpadding="0" cellspacing="0" class="line3">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <div align="left">
                                                                                        <asp:DropDownList ID="selProj1" CssClass="textbox200" runat="server">
                                                                                        </asp:DropDownList>
                                                                                    </div>
                                                                                </td>
                                                                                <td>                          
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <div align="left">
                                                                                        <asp:DropDownList ID="selProj2" CssClass="textbox200" runat="server">
                                                                                        </asp:DropDownList>
                                                                                    </div>
                                                                                </td>
                                                                                <td>                          
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <div align="left">
                                                                                        <asp:DropDownList ID="selProj3" CssClass="textbox200" runat="server">
                                                                                        </asp:DropDownList>
                                                                                    </div>
                                                                                </td>
                                                                                <td>                          
