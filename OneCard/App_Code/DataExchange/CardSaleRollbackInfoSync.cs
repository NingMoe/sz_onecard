//-----------------------------------------------------------------------
// <copyright file="CardSaleRollbackInfoSync.cs" company="linkage">
//   * 功能名: 售卡返销信息同步。
// </copyright>
...
namespace DataExchange
{
    ...
    public class CardSaleRollbackInfoSync : SyncRequest
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public CardSaleRollbackInfoSync()
        {
            this.transCode = "9508";//售卡返销
        }
