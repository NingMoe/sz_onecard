...
{
     // 月票卡售卡
     public class SP_AS_ZJGMonthlyCardNewPDO : PDOBase
     {
         public SP_AS_ZJGMonthlyCardNewPDO()
          {
          }

          protected override void Init()
          {
              InitBegin("SP_AS_ZJGMonthlyCardNew", 31);
               ...
               //UPDATE BY JIANGBB 2012-04-19 加密字段长度修改
               AddField("@custName", "String", "200", "input");
               AddField("@custAddr", "String", "600", "input");
               AddField("@custPhone", "String", "200", "input");
               //add by youyue 20150215 增加是否是补换卡页面标识
               AddField("@isChangeCard", "String", "1", "input");
         ...
         //补换卡页面标识 add by youyue
          public String isChangeCard
          {
              get { return GetString("isChangeCard"); }
              set { SetString("isChangeCard", value); }
          }
          //补换卡页面旧卡卡号 add by youyue
