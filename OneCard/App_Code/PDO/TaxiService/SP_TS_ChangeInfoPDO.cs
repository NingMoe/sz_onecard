...
{
     // 司机信息变更
     public class SP_TS_ChangeInfoPDO : PDOBase
     {
          public SP_TS_ChangeInfoPDO()
          {
          }

          protected override void Init()
          {
                InitBegin("SP_TS_ChangeInfo",30);
               ...
               AddField("@writeCardUseTag", "string", "1", "input");
          ...
          // 写卡标志
          public string writeCardUseTag
          {
              get { return  Getstring("writeCardUseTag"); }
              set { Setstring("writeCardUseTag",value); }
          }
