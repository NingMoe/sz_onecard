...
{
    // 挂失卡转值
    public class SP_PB_TransitBalance_LossPDO : PDOBase
    {
        public SP_PB_TransitBalance_LossPDO()
        {
        }

        protected override void Init()
        {
            InitBegin("SP_PB_TransitBalance_Loss", 20);

            AddField("@SESSIONID", "String", "32", "input");
            AddField("@NEWCARDNO", "string", "16", "input");
            AddField("@LOSSCARDNO", "string", "16", "input");
        ...
        // 旧卡卡号
        public string LOSSCARDNO
        {
            get { return Getstring("LOSSCARDNO"); }
            set { Setstring("LOSSCARDNO", value); }
        }
