...
{
     // 换卡COMMIT
     public class SP_PB_ChangeCard_COMMITPDO : PDOBase
     {
          public SP_PB_ChangeCard_COMMITPDO()
          {
          }

          protected override void Init()
          {
                InitBegin("SP_PB_ChangeCard_COMMIT",35);
               ...
               AddField("@WRITECARDSCRIPT", "string", "200", "input");
               AddField("@CURRENTTIME", "DateTime", "", "output");
               AddField("@TRADEID", "string", "16", "output");
               AddField("@TRADEID2", "string", "16", "output");

               //AddField("@TRADEID3", "string", "16", "output");
               //AddField("@PWD", "string", "32", "input");
               InitEnd();
          }
          ...
          // 写卡信息
          public string WRITECARDSCRIPT
          {
              get { return Getstring("WRITECARDSCRIPT"); }
              set { Setstring("WRITECARDSCRIPT", value); }
          }
          ...
          //// 返回交易序列号
          //public string TRADEID3
          //{
          //    get { return Getstring("TRADEID3"); }
          //    set { Setstring("TRADEID3", value); }
          //}
