...
{
    // 换卡返销
    public class SP_CG_ChangeCardRollbackPDO : PDOBase
    {
        public SP_CG_ChangeCardRollbackPDO()
        {
        }

        protected override void Init()
        {
            InitBegin("SP_CG_ChangeCardRollback", 20);
            ...
            AddField("@writeCardScript", "string", "1024", "input");
