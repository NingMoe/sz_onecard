...
{
     // 消费异常清单临时表
     public class TM_TRADE_ERRORTDO : DDOBase
     {
          public TM_TRADE_ERRORTDO()
          {
          }

          protected override void Init()
          {
               tableName = "TM_TRADE_ERROR";

               columns = new String[33][];
               ...
               columns[30] = new String[]{"MOVESTATE", "string"};
               columns[31] = new String[]{"CHNLTYPE", "string"};
               columns[32] = new String[]{"RSRVCHAR", "string"};
               ...
               hash.Add("MOVESTATE", 30);
               hash.Add("CHNLTYPE", 31);
               hash.Add("RSRVCHAR", 32);
          }
