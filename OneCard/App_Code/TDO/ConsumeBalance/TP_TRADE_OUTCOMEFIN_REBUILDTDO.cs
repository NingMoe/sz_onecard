...
{
     // 商户消费支出转账帐单重出任务表
     public class TP_TRADE_OUTCOMEFIN_REBUILDTDO : DDOBase
     {
          public TP_TRADE_OUTCOMEFIN_REBUILDTDO()
          {
          }

          protected override void Init()
          {
               tableName = "TP_TRADE_OUTCOMEFIN_REBUILD";

               columns = new String[26][];
               ...
               columns[23] = new String[]{"REBUILDSTATECODE", "string"};
               columns[24] = new String[]{"RSRVCHAR", "string"};
               ...
               hash.Add("REBUILDSTATECODE", 23);
               hash.Add("RSRVCHAR", 24);
               hash.Add("REMARK", 25);
          }
