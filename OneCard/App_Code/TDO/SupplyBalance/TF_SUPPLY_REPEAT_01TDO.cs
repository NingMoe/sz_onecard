...
{
     // 非实时充值重复数据清单表
     public class TF_SUPPLY_REPEAT_01TDO : DDOBase
     {
          public TF_SUPPLY_REPEAT_01TDO()
          {
          }

          protected override void Init()
          {
               tableName = "TF_SUPPLY_REPEAT_01";
               ...
               columns[19] = new String[]{"INLISTTIME", "DateTime"};
