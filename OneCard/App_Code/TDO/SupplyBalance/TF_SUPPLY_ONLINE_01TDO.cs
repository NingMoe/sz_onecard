...
{
     // 非实时充值联机清单表
     public class TF_SUPPLY_ONLINE_01TDO : DDOBase
     {
          public TF_SUPPLY_ONLINE_01TDO()
          {
          }

          protected override void Init()
          {
               tableName = "TF_SUPPLY_ONLINE_01";
               ...
               columns[16] = new String[]{"INLISTTIME", "DateTime"};
