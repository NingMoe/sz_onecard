...
{
     // 非实时充值结算实时帐单表
     public class TF_SUPPLY_BALANCE_RT_C1TDO : DDOBase
     {
          public TF_SUPPLY_BALANCE_RT_C1TDO()
          {
          }

          protected override void Init()
          {
               tableName = "TF_SUPPLY_BALANCE_RT_C1";
               ...
               columns[8] = new String[]{"TOTALTIMES", "Int32"};
               columns[9] = new String[]{"TOTALBALFEE", "Int32"};
               ...
               hash.Add("TOTALTIMES", 8);
               hash.Add("TOTALBALFEE", 9);
