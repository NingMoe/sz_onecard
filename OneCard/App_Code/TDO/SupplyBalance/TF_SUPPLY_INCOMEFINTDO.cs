...
{
     // 非实时充值收入转账帐单表
     public class TF_SUPPLY_INCOMEFINTDO : DDOBase
     {
          public TF_SUPPLY_INCOMEFINTDO()
          {
          }

          protected override void Init()
          {
               tableName = "TF_SUPPLY_INCOMEFIN";

               columns = new String[40][];
               ...
               columns[39] = new String[]{"REMARK", "String"};
