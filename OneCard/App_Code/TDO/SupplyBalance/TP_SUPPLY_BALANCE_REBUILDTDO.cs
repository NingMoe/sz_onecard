...
{
     // 非实时充值结算帐单重出任务表
     public class TP_SUPPLY_BALANCE_REBUILDTDO : DDOBase
     {
          public TP_SUPPLY_BALANCE_REBUILDTDO()
          {
          }

          protected override void Init()
          {
               tableName = "TP_SUPPLY_BALANCE_REBUILD";
               ...
               columns[25] = new String[]{"REBUILDSTATECODE", "string"};
