...
{
     // 非实时充值人工回收清单表
     public class TF_SUPPLY_MANUAL_01TDO : DDOBase
     {
          public TF_SUPPLY_MANUAL_01TDO()
          {
          }

          protected override void Init()
          {
               tableName = "TF_SUPPLY_MANUAL_01";

               columns = new String[36][];
               ...
               columns[33] = new String[]{"DEALSTATECODE", "string"};
               columns[34] = new String[]{"BALTIME", "DateTime"};
               columns[35] = new String[]{"RSRVCHAR", "string"};
               ...
               hash.Add("DEALSTATECODE", 33);
               hash.Add("BALTIME", 34);
               hash.Add("RSRVCHAR", 35);
          }
