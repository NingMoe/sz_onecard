...
{
     // 非实时充值异常清单临时表
     public class TM_SUPPLY_ERRORTDO : DDOBase
     {
          public TM_SUPPLY_ERRORTDO()
          {
          }

          protected override void Init()
          {
               tableName = "TM_SUPPLY_ERROR";
               ...
               columns[26] = new String[]{"MOVESTATE", "string"};
               columns[27] = new String[]{"RSRVCHAR", "string"};
               ...
               hash.Add("MOVESTATE", 26);
               hash.Add("RSRVCHAR", 27);
          }
