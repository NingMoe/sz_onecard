...
/*4、园林卡订单小额失败表 */
select * from order_garden_card_mp_log where order_no = '311170112004562150G';

/*5、园林卡订单交易详情 */
select * from trans_common where order_no = '311170112004562150G';

/*6、园林卡订单用户信息 */
select * from user_info where id = (select user_id from order_garden_card where order_no = '311170112004562150G');
