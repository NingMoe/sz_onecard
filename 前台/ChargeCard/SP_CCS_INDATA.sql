...
BEGIN
        ...
        BEGIN
            ...
            LOOP
                BEGIN
                    INSERT INTO TD_XFC_INITCARD (XFCARDNO, NEW_PASSWD,YEAR, BATCHNO, VALUECODE, CORPCODE, CARDSTATECODE, PRODUCETIME, PRODUCESTAFFNO, ENDDATE,Cardtype)
                    VALUES (cur_data.xfcardno, cur_data.new_passwd, cur_data.year, cur_data.batchno, cur_data.valuecode, cur_data.corpcode,
                      cur_data.cardstatecode, cur_data.producetime, cur_data.producestaffno, cur_data.enddate,cur_data.cardtype);
					V_NUM:=V_NUM+1;
                  exception when others then
