create or replace procedure SP_IT_StockOut
(
    p_beginNo            char,
    p_endNo              char,
    p_allotDept          char,
...
begin
 ...
 --3)记台账
    begin
        ...
        values
               (v_TradeID, 'K1', p_volumeno, p_beginNo, 
