...
BEGIN
  ...
  -- 2) 生成ID
    --SELECT TO_CHAR(SYSDATE,'YYMMDDHH24MISS')||V_CUR.CHANNELTYPECODE||SUBSTR(P_CARDNO,-6) INTO V_ID FROM DUAL;
    SELECT V_SEQNO||SUBSTR(P_CARDNO,-4) INTO V_ID FROM DUAL;
    --插入休闲数据信息表
    BEGIN
