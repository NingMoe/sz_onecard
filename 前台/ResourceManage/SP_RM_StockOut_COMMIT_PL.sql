...
CREATE OR REPLACE PROCEDURE SP_RM_StockOut_COMMIT
(
...
BEGIN
    ...
    --用户卡出库
    BEGIN
    SP_RM_StockOut(p_fromCardNo,p_toCardNo,p_assignedStaff,p_serviceCycle,p_serviceFee,
                   p_retValMode,V_CARDPRICE,p_currOper,p_currDept,p_saleType,
                   p_cardPrice,p_getcardorderid,p_alreadygetnum,p_retCode,p_retMsg);
