...
create or replace procedure SP_RM_CHARGECARDAPPLYAPPROVAL
(
...
BEGIN
   v_today := sysdate;
   BEGIN
       for v_c in (select * from tmp_common where F0 = p_sessionID AND F2 = '02')                                                          
        loop                                                          
            --更新领用单表
            BEGIN                                                       
            ...
            BEGIN                                                         
                      ...
                      (
                        ...
                        AGREEGETNUM,     ALREADYGETNUM,				 LATELYGETDATE,           OPERATETIME,            OPERATESTAFF,
                        REMARK
                      )																												
                      values																												
                      (
                        v_seqNo,        '03',                 v_c.f1,                  v_operationCode,         null,
                        null,            null,                 null,                    null,                   null,
                        v_c.f7,          null,							   null,                    null,                   null,
                        null,            null,                 null,                    null,                   null,
                        null,            null,                 null,                    null,                   v_c.f8,
                        v_c.f9,          0,                    null,                    v_today,                v_c.f15,
                        v_c.f16
                      );																												
