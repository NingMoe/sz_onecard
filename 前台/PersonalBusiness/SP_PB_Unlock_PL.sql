CREATE OR REPLACE PROCEDURE SP_PB_Unlock
(
		p_CARDNO	       char,
		p_ASN	           char,
		p_CARDTYPECODE	 char,
...
BEGIN
    ...
    BEGIN
		    ...
		    VALUES          
		        (v_TradeID,'07',p_CARDNO,p_ASN,p_CARDTYPECODE,'02',p_currOper,p_currDept,        
    ...
    BEGIN
		    ...
		    VALUES          
		        (v_TradeID,p_CARDNO,p_ASN,'07','02',p_currOper,p_currDept,v_CURRENTTIME);
    ...
    END;
		...
		BEGIN
		    ...
		    VALUES
		    		(v_TradeID,'07',p_OPERCARDNO,p_CARDNO,v_CURRENTTIME,'0');
