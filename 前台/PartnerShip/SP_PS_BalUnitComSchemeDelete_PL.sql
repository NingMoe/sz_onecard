...
CREATE OR REPLACE PROCEDURE SP_PS_BalUnitComSchemeDelete
(
    p_balUnitNo      CHAR,
    p_comSchemeNo    CHAR,
    p_balComsId      CHAR,
...
BEGIN 
   ...
   BEGIN
     ...
     VALUES(v_seqNo, '68',  p_balUnitNo, p_currOper,  p_currDept, v_currdate, '1'); 
   ...
   --3) add additional log info  into TF_TBALUNIT_COMSCHEMECHANGE
   BEGIN
	 INSERT INTO TF_TBALUNIT_COMSCHEMECHANGE																										
	   (TRADEID, COMSCHEMENO, BALUNITNO, ID, BEGINTIME,	ENDTIME 				   								          )																										
	 VALUES(v_seqNo, p_comSchemeNo, p_balUnitNo, p_balComsId,	
